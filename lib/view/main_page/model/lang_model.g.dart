...
Map<String, dynamic> _$LangModelToJson(LangModel instance) => <String, dynamic>{
      ...
      if (instance.menuMalKabulIade case final value?)
        'menuMalKabulIade': value,
      ...
      if (instance.menuBankaListesi case final value?)
        'menuBankaListesi': value,
      ...
      if (instance.menuNakitTahsilat case final value?)
        'menuNakitTahsilat': value,
      if (instance.menuSenetTahsilati case final value?)
        'menuSenetTahsilati': value,
      if (instance.menuCekTahsilati case final value?)
        'menuCekTahsilati': value,
      ...
      if (instance.menuAlisFaturasi case final value?)
        'menuAlisFaturasi': value,
      if (instance.menuSatisFaturasi case final value?)
        'menuSatisFaturasi': value,
      ...
      if (instance.genelKullaniciAdi case final value?)
        'genelKullaniciAdi': value,
      ...
      if (instance.genelSiparisTipi case final value?)
        'genelSiparisTipi': value,
      ...
      if (instance.genelMalFazTutari case final value?)
        'genelMalFazTutari': value,
      ...
      if (instance.genelGenelToplam case final value?)
        'genelGenelToplam': value,
      if (instance.genelGenelIskonto case final value?)
        'genelGenelIskonto': value,
      if (instance.genelStokSeviyesi case final value?)
        'genelStokSeviyesi': value,
      ...
      if (instance.genelKalemMiktari case final value?)
        'genelKalemMiktari': value,
      ...
      if (instance.genelAlisFaturasi case final value?)
        'genelAlisFaturasi': value,
      ...
      if (instance.genelXSilinsinMi case final value?)
        'genelXSilinsinMi': value,
      ...
      if (instance.genelDovizSeciniz case final value?)
        'genelDovizSeciniz': value,
      ...
      if (instance.genelProjeSeciniz case final value?)
        'genelProjeSeciniz': value,
      if (instance.genelCariSeciniz case final value?)
        'genelCariSeciniz': value,
      if (instance.genelTarihSeciniz case final value?)
        'genelTarihSeciniz': value,
      ...
      if (instance.genelStokSeciniz case final value?)
        'genelStokSeciniz': value,
      ...
      if (instance.genelXBulunamadi case final value?)
        'genelXBulunamadi': value,
      if (instance.genelMuhasebeKoduSeciniz case final value?)
        'genelMuhasebeKoduSeciniz': value,
      if (instance.genelFiyatGiriniz case final value?)
        'genelFiyatGiriniz': value,
      ...
      if (instance.genelHucreSeciniz case final value?)
        'genelHucreSeciniz': value,
      ...
      if (instance.genelDepoSeciniz case final value?)
        'genelDepoSeciniz': value,
      if (instance.genelBelgeSeciniz case final value?)
        'genelBelgeSeciniz': value,
      if (instance.genelBelgeTuru case final value?) 'genelBelgeTuru': value,
      if (instance.genelBelgeTarihi case final value?)
        'genelBelgeTarihi': value,
      if (instance.genelIslemMiktari case final value?)
        'genelIslemMiktari': value,
      ...
      if (instance.genelKaynakHucre case final value?)
        'genelKaynakHucre': value,
      ...
      if (instance.genelXHareketleri case final value?)
        'genelXHareketleri': value,
      ...
      if (instance.genelSatisFiyati case final value?)
        'genelSatisFiyati': value,
      ...
      if (instance.genelBitisTarihi case final value?)
        'genelBitisTarihi': value,
      ...
      if (instance.genelKullanicilar case final value?)
        'genelKullanicilar': value,
      if (instance.genelCariKoduBos case final value?)
        'genelCariKoduBos': value,
      ...
      if (instance.genelStokKoduBos case final value?)
        'genelStokKoduBos': value,
      if (instance.genelBelgeZatenKayitli case final value?)
        'genelBelgeZatenKayitli': value,
      if (instance.genelKayitYapildi case final value?)
        'genelKayitYapildi': value,
      ...
      if (instance.genelYeniBelgeNo case final value?)
        'genelYeniBelgeNo': value,
      ...
      if (instance.genelKasaSeciniz case final value?)
        'genelKasaSeciniz': value,
      ...
      if (instance.genelCariEFTKaydi case final value?)
        'genelCariEFTKaydi': value,
      if (instance.bankayaParaGirisi case final value?)
        'bankayaParaGirisi': value,
      ...
      if (instance.hucreBakiyeDurumu case final value?)
        'HucreBakiyeDurumu': value,
      if (instance.hucreHareketleri case final value?)
        'HucreHareketleri': value,
      ...
      if (instance.faturaHareketTuru case final value?)
        'faturaHareketTuru': value,
      if (instance.faturaCikisYeri case final value?) 'faturaCikisYeri': value,
      if (instance.faturaMasrafKodu case final value?)
        'faturaMasrafKodu': value,
      if (instance.faturaFarkliTeslimat case final value?)
        'faturaFarkliTeslimat': value,
      if (instance.faturaIthalatTipi case final value?)
        'faturaIthalatTipi': value,
      ...
      if (instance.faturaAnaMalGrubu case final value?)
        'faturaAnaMalGrubu': value,
