...
Map<String, dynamic> _$ParamModelToJson(ParamModel instance) {
  ...
  writeNotNull('SatisMiktar1Gelsin', instance.satisMiktar1Gelsin);
  ...
  writeNotNull('AlisMuhRefKodSorulsun', instance.alisMuhRefKodSorulsun);
  ...
  writeNotNull('CariRotaUygulamasi', instance.cariRotaUygulamasi);
  return val;
}
