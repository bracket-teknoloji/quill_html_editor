  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Form(
            ...
            child: SingleChildScrollView(
              child: Observer(
                  builder: (_) => Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                        Observer(
                            ...
                            suffix: IconButton(
                              onPressed: () async {
                                if (viewModel.model.hesapKodu != null) {
                                  await dialogManager.showCariGridViewDialog(CariListesiModel(cariKodu: viewModel.model.hesapKodu));
                                } else {
                        ...
                        CustomTextField(
                          ...
                          onTap: () async {
                            ...
                            final result = await bottomSheetDialogManager.showRadioBottomSheetDialog(context,
                                title: "Referans Kodu",
                                children: viewModel.muhaRefList!.map((MuhasebeReferansModel e) => BottomSheetModel(title: e.tanimi ?? "", description: e.kodu, value: e)).toList());
                        ...
                        CustomTextField(
                          ...
                          onChanged: (String value) => viewModel.setHedefAciklama(value),
                        ),
