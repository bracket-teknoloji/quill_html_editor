...
mixin _$NakitOdemeViewModel on _NakitOdemeViewModelBase, Store {
  ...
  @override
  String get formTipi => (_$formTipiComputed ??= Computed<String>(
    () => super.formTipi,
  ...
  late final _$cariBakiyeAtom = Atom(
    name: '_NakitOdemeViewModelBase.cariBakiye',
    context: context,
  );
  ...
  late final _$cariModelAtom = Atom(
    name: '_NakitOdemeViewModelBase.cariModel',
    context: context,
  );
  ...
  late final _$modelAtom = Atom(
    name: '_NakitOdemeViewModelBase.model',
    context: context,
  );
  ...
  late final _$dovizKurlariListesiAtom = Atom(
    name: '_NakitOdemeViewModelBase.dovizKurlariListesi',
    context: context,
  );
  ...
  late final _$muhaRefListAtom = Atom(
    name: '_NakitOdemeViewModelBase.muhaRefList',
    context: context,
  );
  ...
  late final _$kasaAtom = Atom(
    name: '_NakitOdemeViewModelBase.kasa',
    context: context,
  );
  ...
  late final _$showReferansKoduAtom = Atom(
    name: '_NakitOdemeViewModelBase.showReferansKodu',
    context: context,
  );
  ...
  late final _$getSiradakiKodAsyncAction = AsyncAction(
    '_NakitOdemeViewModelBase.getSiradakiKod',
    context: context,
  );
  ...
  late final _$getKasalarAsyncAction = AsyncAction(
    '_NakitOdemeViewModelBase.getKasalar',
    context: context,
  );
  ...
  late final _$getMuhaRefListAsyncAction = AsyncAction(
    '_NakitOdemeViewModelBase.getMuhaRefList',
    context: context,
  );
  ...
  late final _$getDovizlerAsyncAction = AsyncAction(
    '_NakitOdemeViewModelBase.getDovizler',
    context: context,
  );
  ...
  late final _$postDataAsyncAction = AsyncAction(
    '_NakitOdemeViewModelBase.postData',
    context: context,
  );
