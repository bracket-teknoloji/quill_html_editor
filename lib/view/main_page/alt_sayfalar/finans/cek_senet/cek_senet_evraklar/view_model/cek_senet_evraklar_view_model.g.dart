...
mixin _$CekSenetEvraklarViewModel on _CekSenetEvraklarViewModelBase, Store {
  late final _$evraklarListesiAtom = Atom(name: '_CekSenetEvraklarViewModelBase.evraklarListesi', context: context);
  ...
  late final _$requestModelAtom = Atom(name: '_CekSenetEvraklarViewModelBase.requestModel', context: context);
  ...
  set requestModel(EvraklarRequestModel value) {
    _$requestModelAtom.reportWrite(value, _requestModelIsInitialized ? super.requestModel : null, () {
      super.requestModel = value;
      _requestModelIsInitialized = true;
    });
  }

  late final _$resetPageAsyncAction = AsyncAction('_CekSenetEvraklarViewModelBase.resetPage', context: context);
  ...
  late final _$deleteEvrakAsyncAction = AsyncAction('_CekSenetEvraklarViewModelBase.deleteEvrak', context: context);
  ...
  late final _$uploadEvrakAsyncAction = AsyncAction('_CekSenetEvraklarViewModelBase.uploadEvrak', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_CekSenetEvraklarViewModelBase.getData', context: context);
