...
_EvraklarModel _$EvraklarModelFromJson(Map<String, dynamic> json) => _EvraklarModel(
...
Map<String, dynamic> _$EvraklarModelToJson(_EvraklarModel instance) => <String, dynamic>{
