...
final class _CekSenetTahsilatEkleViewState extends BaseState<CekSenetTahsilatEkleView> {
  ...
  void initState() {
    ...
    if (yetkiController.varsayilanMuhRefKodu case final muhRefKodu?) {
      viewModel.setReferans(MuhasebeReferansModel(kodu: muhRefKodu.hesapKodu, tanimi: muhRefKodu.hesapAdi));
  ...
  Future<void> getBankaHesapKodu() async {
    ...
    final result = await Get.toNamed(
      ...
      arguments: BankaListesiRequestModel(belgeTipi: widget.cekSenetListesiEnum.belgeTipi, menuKodu: "YONE_BHRE"),
    );
  ...
  Future<void> getbanka() async {
    final TcmbBankalarModel? result = await bottomSheetDialogManager.showTcmbBankalarBottomSheetDialog(
      context,
      viewModel.model.cekBanka,
    );
    if (result != null) {
  ...
  Future<void> getSube() async {
    ...
    final TcmbBankalarModel? result = await bottomSheetDialogManager.showTcmbSubelerBottomSheetDialog(
      context,
      viewModel.model.cekBanka,
      viewModel.model.cekSube,
    );
    if (result != null) {
  ...
  Future<void> initModel() async {
    ...
    _dovizKuruController.text =
        viewModel.model.dovizKuru?.commaSeparatedWithDecimalDigits(OndalikEnum.dovizFiyati) ?? "";
    _tutarController.text = viewModel.model.tutar?.commaSeparatedWithDecimalDigits(OndalikEnum.tutar) ?? "";
