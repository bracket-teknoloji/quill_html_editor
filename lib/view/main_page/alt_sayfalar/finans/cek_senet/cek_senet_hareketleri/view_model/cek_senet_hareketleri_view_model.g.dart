...
mixin _$CekSenetHareketleriViewModel on _CekSenetHareketleriViewModelBase, Store {
  ...
  @override
  set cekSenetHareketleriListesi(ObservableList<CekSenetHareketleriModel>? value) {
    _$cekSenetHareketleriListesiAtom.reportWrite(value, super.cekSenetHareketleriListesi, () {
      super.cekSenetHareketleriListesi = value;
    });
  }

  late final _$getDataAsyncAction = AsyncAction('_CekSenetHareketleriViewModelBase.getData', context: context);
  ...
  void setCekSenetListesiModel(CekSenetListesiModel model) {
    ...
    try {
      ...
      _$_CekSenetHareketleriViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
