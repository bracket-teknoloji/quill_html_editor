...
mixin _$BankaListesiRequestModel {
  String? get bakiye => throw _privateConstructorUsedError;
...
class _$BankaListesiRequestModelImpl implements _BankaListesiRequestModel {
  _$BankaListesiRequestModelImpl({this.bakiye, this.arrHesapTipi, this.haricHesaplarArray, this.sirala, this.ekranTipi = "R", this.menuKodu, this.belgeTipi, this.bankaKodu, this.islemModulu});
