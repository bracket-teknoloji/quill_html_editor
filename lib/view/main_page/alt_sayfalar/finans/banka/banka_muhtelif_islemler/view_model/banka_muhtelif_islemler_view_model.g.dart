...
mixin _$BankaMuhtelifIslemlerViewModel on _BankaMuhtelifIslemlerViewModelBase, Store {
  ...
  late final _$modelAtom = Atom(name: '_BankaMuhtelifIslemlerViewModelBase.model', context: context);
  ...
  late final _$seriListAtom = Atom(name: '_BankaMuhtelifIslemlerViewModelBase.seriList', context: context);
  ...
  late final _$getSeriAsyncAction = AsyncAction('_BankaMuhtelifIslemlerViewModelBase.getSeri', context: context);
  ...
  void setBelgeTuru(String? belgeTuru) {
    ...
    try {
      ...
      _$_BankaMuhtelifIslemlerViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
