...
mixin _$HesaplarArasiIslemViewModel on _HesaplarArasiIslemViewModelBase, Store {
  late final _$modelAtom = Atom(name: '_HesaplarArasiIslemViewModelBase.model', context: context);
  ...
  set cikisBankaListesiRequestModel(BankaListesiRequestModel value) {
    _$cikisBankaListesiRequestModelAtom.reportWrite(value, super.cikisBankaListesiRequestModel, () {
  ...
  set girisBankaListesiRequestModel(BankaListesiRequestModel value) {
    _$girisBankaListesiRequestModelAtom.reportWrite(value, super.girisBankaListesiRequestModel, () {
  ...
  late final _$bankaDovizliMiAtom = Atom(name: '_HesaplarArasiIslemViewModelBase.bankaDovizliMi', context: context);
  ...
  late final _$getDovizlerAsyncAction = AsyncAction('_HesaplarArasiIslemViewModelBase.getDovizler', context: context);
  ...
  late final _$saveTahsilatAsyncAction = AsyncAction('_HesaplarArasiIslemViewModelBase.saveTahsilat', context: context);
  ...
  void setBankaDovizliMi(bool value) {
    ...
    try {
      ...
      _$_HesaplarArasiIslemViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
