...
mixin _$BankaHareketleriViewModel on _BankaHareketleriViewModelBase, Store {
  ...
  @override
  double get bakiye =>
      (_$bakiyeComputed ??= Computed<double>(() => super.bakiye, name: '_BankaHareketleriViewModelBase.bakiye')).value;
  ...
  late final _$requestModelAtom = Atom(name: '_BankaHareketleriViewModelBase.requestModel', context: context);
  ...
  set bankaHareketleriListesi(ObservableList<BankaHareketleriModel>? value) {
    _$bankaHareketleriListesiAtom.reportWrite(value, super.bankaHareketleriListesi, () {
      super.bankaHareketleriListesi = value;
    });
  }

  late final _$getDataAsyncAction = AsyncAction('_BankaHareketleriViewModelBase.getData', context: context);
