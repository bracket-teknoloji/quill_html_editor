...
_$OrtalamaVadeTarihiModelImpl _$$OrtalamaVadeTarihiModelImplFromJson(Map<String, dynamic> json) =>
    _$OrtalamaVadeTarihiModelImpl(
      vadeTarihi: json['VADE_TARIHI'] == null ? null : DateTime.parse(json['VADE_TARIHI'] as String),
      tutar: (json['TUTAR'] as num?)?.toDouble(),
    );

Map<String, dynamic> _$$OrtalamaVadeTarihiModelImplToJson(_$OrtalamaVadeTarihiModelImpl instance) => <String, dynamic>{
