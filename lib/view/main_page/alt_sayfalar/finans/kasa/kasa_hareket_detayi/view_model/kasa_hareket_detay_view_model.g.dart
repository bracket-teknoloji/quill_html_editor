...
mixin _$KasaHareketDetayViewModel on _KasaHareketDetayViewModelBase, Store {
  late final _$messageAtom =
      Atom(name: '_KasaHareketDetayViewModelBase.message', context: context);
  ...
  late final _$getDataAsyncAction =
      AsyncAction('_KasaHareketDetayViewModelBase.getData', context: context);
  ...
  late final _$_KasaHareketDetayViewModelBaseActionController =
      ActionController(
          name: '_KasaHareketDetayViewModelBase', context: context);

  @override
  void setKasaIslemleriModel(KasaIslemleriModel? value) {
    final _$actionInfo =
        _$_KasaHareketDetayViewModelBaseActionController.startAction(
