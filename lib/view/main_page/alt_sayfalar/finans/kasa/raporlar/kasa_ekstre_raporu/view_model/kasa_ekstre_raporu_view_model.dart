...
class KasaEkstreRaporuViewModel = _KasaEkstreRaporuViewModelBase
    with _$KasaEkstreRaporuViewModel;
...
abstract class _KasaEkstreRaporuViewModelBase with Store {
  ...
  void setKasaKodu(String? value) =>
      pdfModel.dicParams = pdfModel.dicParams!.copyWith(kasaKodu: value);
