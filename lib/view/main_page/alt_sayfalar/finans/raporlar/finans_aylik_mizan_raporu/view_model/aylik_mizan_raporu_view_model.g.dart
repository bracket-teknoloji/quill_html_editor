...
mixin _$AylikMizanRaporuViewModel on _AylikMizanRaporuViewModelBase, Store {
  ...
  late final _$_AylikMizanRaporuViewModelBaseActionController = ActionController(name: '_AylikMizanRaporuViewModelBase', context: context);

  @override
  void setFuture() {
    final _$actionInfo = _$_AylikMizanRaporuViewModelBaseActionController.startAction(name: '_AylikMizanRaporuViewModelBase.setFuture');
    try {
  ...
  @override
  void resetFuture() {
    final _$actionInfo = _$_AylikMizanRaporuViewModelBaseActionController.startAction(name: '_AylikMizanRaporuViewModelBase.resetFuture');
    try {
  ...
  void changeMuhasebeKodu(String? value) {
    final _$actionInfo = _$_AylikMizanRaporuViewModelBaseActionController.startAction(name: '_AylikMizanRaporuViewModelBase.changeMuhasebeKodu');
    try {
