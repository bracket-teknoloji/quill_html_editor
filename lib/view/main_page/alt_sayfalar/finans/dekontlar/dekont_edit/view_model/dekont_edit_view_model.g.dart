...
mixin _$DekontEditViewModel on _DekontEditViewModelBase, Store {
  late final _$selectedTabAtom = Atom(
    name: '_DekontEditViewModelBase.selectedTab',
    context: context,
  );
  ...
  late final _$kalemSayisiAtom = Atom(
    name: '_DekontEditViewModelBase.kalemSayisi',
    context: context,
  );
  ...
  late final _$islemTamamlandiAtom = Atom(
    name: '_DekontEditViewModelBase.islemTamamlandi',
    context: context,
  );
  ...
  late final _$postDataAsyncAction = AsyncAction(
    '_DekontEditViewModelBase.postData',
    context: context,
  );
  ...
  late final _$getDataAsyncAction = AsyncAction(
    '_DekontEditViewModelBase.getData',
    context: context,
  );
