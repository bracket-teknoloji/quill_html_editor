...
_DekontListesiModel _$DekontListesiModelFromJson(Map<String, dynamic> json) => _DekontListesiModel(
...
Map<String, dynamic> _$DekontListesiModelToJson(_DekontListesiModel instance) => <String, dynamic>{
