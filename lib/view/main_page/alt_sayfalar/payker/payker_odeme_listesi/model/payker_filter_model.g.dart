...
_PaykerFilterModel _$PaykerFilterModelFromJson(Map<String, dynamic> json) => _PaykerFilterModel(
  ...
  columns: (json['Columns'] as List<dynamic>?)?.map((e) => PaykerColumn.fromJson(e as Map<String, dynamic>)).toList(),
  order: (json['Order'] as List<dynamic>?)?.map((e) => Order.fromJson(e as Map<String, dynamic>)).toList(),
  start: (json['Start'] as num?)?.toInt(),
  length: (json['Length'] as num?)?.toInt(),
  search: json['Search'] == null ? null : Search.fromJson(json['Search'] as Map<String, dynamic>),
...
Map<String, dynamic> _$PaykerFilterModelToJson(
  ...
  if (instance.filterModels?.map((e) => e.toJson()).toList() case final value?) 'FilterModels': value,
  if (instance.draw case final value?) 'Draw': value,
  if (instance.columns?.map((e) => e.toJson()).toList() case final value?) 'Columns': value,
  if (instance.order?.map((e) => e.toJson()).toList() case final value?) 'Order': value,
...
_PaykerColumn _$PaykerColumnFromJson(Map<String, dynamic> json) => _PaykerColumn(
...
Map<String, dynamic> _$PaykerColumnToJson(_PaykerColumn instance) => <String, dynamic>{
...
Map<String, dynamic> _$FilterModelToJson(_FilterModel instance) => <String, dynamic>{
...
_Search _$SearchFromJson(Map<String, dynamic> json) => _Search(value: json['Value'], regex: json['Regex'] as bool?);
