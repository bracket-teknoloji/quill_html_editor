...
@useResult
$Res call({
 int? id, int? firmaId, String? kartIsim, String? kartNo, String? enrollmentId, String? transactionId, double? tutar, String? aciklama, String? odemeTuru, String? ipAdres, int? bankaId, dynamic bayiId, String? durum, String? durumKodu, String? durumAciklama, dynamic odemelinkId, String? responsedata, Banka? banka, dynamic bayi, dynamic firma, dynamic odemeLink, dynamic silindi, String? siparisNo, DateTime? kayittarihi, dynamic kayityapankul, DateTime? duzeltmetarihi, dynamic duzeltmeyapankul
});
