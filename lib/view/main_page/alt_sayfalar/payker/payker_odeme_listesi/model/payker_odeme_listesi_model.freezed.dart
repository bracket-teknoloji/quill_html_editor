...
/// Adds pattern-matching-related methods to [BasePaykerOdemeListesiModel].
extension BasePaykerOdemeListesiModelPatterns on BasePaykerOdemeListesiModel {
...
@useResult
$Res call({
 int? id, int? firmaId, String? kartIsim, String? kartNo, String? enrollmentId, String? transactionId, double? tutar, String? aciklama, String? ipAdres, int? bankaId, dynamic bayiId, String? durum, String? durumKodu, String? durumAciklama, dynamic odemelinkId, String? responsedata, Banka? banka, dynamic bayi, dynamic firma, dynamic odemeLink, dynamic silindi, String? siparisNo, String? firmaKodu, DateTime? kayittarihi, dynamic kayityapankul, DateTime? duzeltmetarihi, dynamic duzeltmeyapankul, String? belgeNo, String? uygulama, String? platform, String? erpSirket, int? erpIsletmeKodu, DateTime? alinmaTarihi, int? taksitSayisi
});
...
/// Adds pattern-matching-related methods to [PaykerOdemeListesiModel].
extension PaykerOdemeListesiModelPatterns on PaykerOdemeListesiModel {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
