...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,firmaId,kartIsim,kartNo,enrollmentId,transactionId,tutar,aciklama,odemeTuru,ipAdres,bankaId,const DeepCollectionEquality().hash(bayiId),durum,durumKodu,durumAciklama,const DeepCollectionEquality().hash(odemelinkId),responsedata,banka,const DeepCollectionEquality().hash(bayi),const DeepCollectionEquality().hash(firma),const DeepCollectionEquality().hash(odemeLink),const DeepCollectionEquality().hash(silindi),kayittarihi,const DeepCollectionEquality().hash(kayityapankul),duzeltmetarihi,const DeepCollectionEquality().hash(duzeltmeyapankul)]);
...
@useResult
$Res call({
 int? id, int? firmaId, String? kartIsim, String? kartNo, String? enrollmentId, String? transactionId, double? tutar, String? aciklama, String? odemeTuru, String? ipAdres, int? bankaId, dynamic bayiId, String? durum, String? durumKodu, String? durumAciklama, dynamic odemelinkId, String? responsedata, Banka? banka, dynamic bayi, dynamic firma, dynamic odemeLink
});
