...
mixin _$HucreAraViewModel on _HucreAraViewModelBase, Store {
  late final _$stokListAtom =
      Atom(name: '_HucreAraViewModelBase.stokList', context: context);
  ...
  late final _$getDataAsyncAction =
      AsyncAction('_HucreAraViewModelBase.getData', context: context);
  ...
  late final _$_HucreAraViewModelBaseActionController =
      ActionController(name: '_HucreAraViewModelBase', context: context);
