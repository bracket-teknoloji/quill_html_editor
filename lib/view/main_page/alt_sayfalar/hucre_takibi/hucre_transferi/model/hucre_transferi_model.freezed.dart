...
/// Adds pattern-matching-related methods to [HucreTransferiModel].
extension HucreTransferiModelPatterns on HucreTransferiModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _HucreTransferiModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _HucreTransferiModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _HucreTransferiModel value)  $default,){
final _that = this;
switch (_that) {
case _HucreTransferiModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _HucreTransferiModel value)?  $default,){
final _that = this;
switch (_that) {
case _HucreTransferiModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? depoKodu, @JsonKey(includeFromJson: false, includeToJson: false)  String? depoTanimi, @JsonKey(includeFromJson: false, includeToJson: false)  BelgeRehberiModel? belgeModel,  String? hedefHucre,  String? hucreKodu,  String? islemTuru,  String? pickerBelgeTuru,  double? miktar,  String? stokKodu,  String? stokAdi,  String? paketKodu,  String? belgeTuru,  String? belgeNo,  String? cariKodu)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HucreTransferiModel() when $default != null:
return $default(_that.depoKodu,_that.depoTanimi,_that.belgeModel,_that.hedefHucre,_that.hucreKodu,_that.islemTuru,_that.pickerBelgeTuru,_that.miktar,_that.stokKodu,_that.stokAdi,_that.paketKodu,_that.belgeTuru,_that.belgeNo,_that.cariKodu);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? depoKodu, @JsonKey(includeFromJson: false, includeToJson: false)  String? depoTanimi, @JsonKey(includeFromJson: false, includeToJson: false)  BelgeRehberiModel? belgeModel,  String? hedefHucre,  String? hucreKodu,  String? islemTuru,  String? pickerBelgeTuru,  double? miktar,  String? stokKodu,  String? stokAdi,  String? paketKodu,  String? belgeTuru,  String? belgeNo,  String? cariKodu)  $default,) {final _that = this;
switch (_that) {
case _HucreTransferiModel():
return $default(_that.depoKodu,_that.depoTanimi,_that.belgeModel,_that.hedefHucre,_that.hucreKodu,_that.islemTuru,_that.pickerBelgeTuru,_that.miktar,_that.stokKodu,_that.stokAdi,_that.paketKodu,_that.belgeTuru,_that.belgeNo,_that.cariKodu);}
}
