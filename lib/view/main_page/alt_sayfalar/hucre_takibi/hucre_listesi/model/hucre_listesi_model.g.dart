...
_HucreListesiModel _$HucreListesiModelFromJson(Map<String, dynamic> json) => _HucreListesiModel(
...
Map<String, dynamic> _$HucreListesiModelToJson(_HucreListesiModel instance) => <String, dynamic>{
