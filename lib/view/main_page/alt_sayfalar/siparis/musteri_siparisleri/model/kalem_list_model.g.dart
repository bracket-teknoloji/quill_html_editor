...
KalemListModel _$KalemListModelFromJson(Map<String, dynamic> json) =>
    KalemListModel()
      ...
      ..dipFiyat = json['DIP_FIYAT'] as int?
      ...
      ..olcuBirimCarpani = json['OLCU_BIRIM_CARPANI'] as int?
      ...
      ..stokBakiye = json['STOK_BAKIYE'] as int?
      ..kosulKodu = json['KOSUL_KODU'] as String?
      ..stokBirimAgirlik = json['STOK_BIRIM_AGIRLIK'] as int?;
