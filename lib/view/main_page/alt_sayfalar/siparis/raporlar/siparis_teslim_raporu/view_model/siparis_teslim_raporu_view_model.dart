...
abstract class _SiparisTeslimRaporuViewModelBase with Store {
  ...
  @observable
  PdfModel pdfModel = PdfModel(raporOzelKod: siparisTipiEnum == SiparisTipiEnum.musteri ? "Rapor_SiparisMSTeslim" : "Rapor_SiparisSSTeslim", standart: true, dicParams: DicParams());
  @observable
  bool kapaliMi = false;
  @observable
  bool durum = false;
