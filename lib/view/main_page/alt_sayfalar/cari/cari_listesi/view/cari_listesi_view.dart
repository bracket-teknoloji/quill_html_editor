  ...
  AppBar appBar(BuildContext context) => AppBar(
        title: Observer(
          builder: (_) => (viewModel.searchBar
              ? CustomAppBarTextField(onFieldSubmitted: (String value) async {
                      ...
                      child: Listener(
                        onPointerDown: (PointerDownEvent event) async {
                          if (event.kind == PointerDeviceKind.mouse && event.buttons == 2) {
                            await showIslemlerDialog(object);
                          }
                        },
                        child: ListTile(
                          onLongPress: () async => await showIslemlerDialog(object),
                          onTap: () async {
                            if (widget.isGetData ?? false) {
                              Get.back(result: object);
                            } else {
                              await cariBottomSheet(context, object);
                            }
                          },
                          isThreeLine: true,
                          ...
                          subtitle: Wrap(
                            ...
                            children: <Widget>[
                              ...
                              if (object.cariIl != null)
                                Text("${object.cariIl ?? ""}${object.cariIlce != null ? "/${object.cariIlce}" : ""}", style: TextStyle(color: theme.textTheme.bodySmall?.color?.withOpacity(0.5)))
                              else
                                const SizedBox(),
                              Row(
                                children: <Widget>[
                                  ...
                                  // object.dovizAdi != null ? Badge(label: Text(("Dövizli ${object.dovizAdi}"))) : const SizedBox(),
                                    ...
                                    .map(
                                      (Widget e) => e is! SizedBox? ? e.paddingOnly(top: UIHelper.lowSize, right: UIHelper.lowSize) : null,
                                    )
                                    .toList()
  ...
  Future<void> cariBottomSheet(BuildContext context, CariListesiModel object) async {
          ...
          BottomSheetModel(
            ...
            onTap: () async {
              ...
              await dialogManager.showAreYouSureDialog(() async {
                ...
                final GenericResponseModel<NetworkManagerMixin> result = await networkManager.dioPost<CariListesiModel>(
                  path: ApiUrls.deleteCari,
                  bodyModel: CariListesiModel(),
                  queryParameters: <String, dynamic>{"CariKodu": object.cariKodu ?? ""},
                );
                dialogManager.hideAlertDialog;
    ...
    if (pageName != null) {
      ...
      if (pageName is CariSeceneklerModel) {
        ...
        await Get.toNamed(pageName, arguments: object);
      }
    }
  }

  Future<dynamic> showIslemlerDialog(CariListesiModel object) => dialogManager.showCariGridViewDialog(object, onSelected: (bool value) async => await viewModel.resetPage());
          ...
          CustomWidgetWithLabel(
            ...
            child: Observer(
                builder: (_) => SlideControllerWidget(
                    ...
                    filterOnChanged: (int? index) => viewModel.changeFilterBakiye(viewModel.bakiyeMap.values.toList()[index ?? 0]),
            ...
            children: <Widget>[
              Expanded(
                ...
                onTap: () async {
                  ...
                  if (result != null) {
                    viewModel.changeArrPlasiyerKodu(result.map((PlasiyerList? e) => e?.plasiyerKodu).toList());
              ...
              Expanded(
                ...
                onTap: () async {
                  ...
                  if (result is List) {
                    ...
                    viewModel.changeArrSehir(list.map((CariSehirlerModel? e) => e?.sehirAdi).toList());
                    sehirController.text = list.map((CariSehirlerModel? e) => e?.sehirAdi).join(", ");
                    await viewModel.resetPage();
                  }
                },
              )),
                              ...
                              child: CustomTextField(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (result is List) {
                                      ...
                                      kod0Controller.text = list.map((BaseGrupKoduModel? e) => e?.grupAdi).join(", ");
                                      await viewModel.resetPage();
                                    }
                                  }),
                            ).yetkiVarMi(viewModel.grupKodlari?.any((BaseGrupKoduModel element) => element.grupNo == 0) ?? false),
                            Expanded(
                              child: CustomTextField(
                                  labelText: "Kod 1",
                                  ...
                                  onTap: () async {
                                    final result = await bottomSheetDialogManager.showCheckBoxBottomSheetDialog(context,
                                        title: "Kod Seçiniz",
                                        children: List.generate(viewModel.getGrupKod1?.length ?? 0,
                                    ...
                                    if (result is List) {
                                      ...
                                      kod1Controller.text = list.map((BaseGrupKoduModel? e) => e?.grupAdi).join(", ");
                                      await viewModel.resetPage();
                                    }
                                  }),
                            ).yetkiVarMi(viewModel.grupKodlari?.any((BaseGrupKoduModel element) => element.grupNo == 1) ?? false),
                          ],
                        ),
                        Row(
                          children: <Widget>[
                              ...
                              child: CustomTextField(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (result is List) {
                                      ...
                                      kod2Controller.text = list.map((BaseGrupKoduModel? e) => e?.grupAdi).join(", ");
                                      await viewModel.resetPage();
                                    }
                                  }),
                            ).yetkiVarMi(viewModel.grupKodlari?.any((BaseGrupKoduModel element) => element.grupNo == 2) ?? false),
                            Expanded(
                              child: CustomTextField(
                                  labelText: "Kod 3",
                                  ...
                                  onTap: () async {
                                    ...
                                    if (result is List) {
                                      ...
                                      kod3Controller.text = list.map((BaseGrupKoduModel? e) => e?.grupAdi).join(", ");
                                      await viewModel.resetPage();
                                    }
                                  }),
                            ).yetkiVarMi(viewModel.grupKodlari?.any((BaseGrupKoduModel element) => element.grupNo == 3) ?? false),
                          ],
                        ),
                        Row(
                          children: <Widget>[
                              ...
                              child: CustomTextField(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (result is List) {
                                      ...
                                      kod4Controller.text = list.map((BaseGrupKoduModel? e) => e?.grupAdi).join(", ");
                                      await viewModel.resetPage();
                                    }
                                  }),
                            ).yetkiVarMi(viewModel.grupKodlari?.any((BaseGrupKoduModel element) => element.grupNo == 4) ?? false),
                            Expanded(
                              child: CustomTextField(
                                  labelText: "Kod 5",
                                  ...
                                  onTap: () async {
                                    ...
                                    if (result is List) {
                                      ...
                                      kod5Controller.text = list.map((BaseGrupKoduModel? e) => e?.grupAdi).join(", ");
                                      await viewModel.resetPage();
                                    }
                                  }),
                            ).yetkiVarMi(viewModel.grupKodlari?.any((BaseGrupKoduModel element) => element.grupNo == 5) ?? false),
                          ],
                        ),
                      ],
                    ),
