...
final class CariSaveRequestModel with NetworkManagerMixin {
  ...
  factory CariSaveRequestModel.mukellefiyetDegistir(CariSaveRequestModel? model) =>
      CariSaveRequestModel(requestVersion: 6, kodu: model?.kodu, islemKodu: model?.efatAktif == true ? 6 : 5);
  //singleton
