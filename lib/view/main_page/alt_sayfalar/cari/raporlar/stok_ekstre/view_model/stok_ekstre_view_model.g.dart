...
mixin _$StokEkstreViewModel on _StokEkstreViewModelBase, Store {
  ...
  late final _$_StokEkstreViewModelBaseActionController = ActionController(name: '_StokEkstreViewModelBase', context: context);

  @override
  void changeCariKodu(dynamic value) {
    final _$actionInfo = _$_StokEkstreViewModelBaseActionController.startAction(name: '_StokEkstreViewModelBase.changeCariKodu');
    try {
  ...
  void changeDovizTipi(int value) {
    final _$actionInfo = _$_StokEkstreViewModelBaseActionController.startAction(name: '_StokEkstreViewModelBase.changeDovizTipi');
    try {
  ...
  @override
  void setFuture() {
    final _$actionInfo = _$_StokEkstreViewModelBaseActionController.startAction(name: '_StokEkstreViewModelBase.setFuture');
    try {
  ...
  @override
  void resetFuture() {
    final _$actionInfo = _$_StokEkstreViewModelBaseActionController.startAction(name: '_StokEkstreViewModelBase.resetFuture');
    try {
