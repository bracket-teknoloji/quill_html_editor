...
mixin _$HareketDetayliYaslandirmaRaporuViewModel on _HareketDetayliYaslandirmaRaporuViewModelBase, Store {
  late final _$bakiyeDurumuGroupValueAtom = Atom(name: '_HareketDetayliYaslandirmaRaporuViewModelBase.bakiyeDurumuGroupValue', context: context);
  ...
  late final _$futureControllerAtom = Atom(name: '_HareketDetayliYaslandirmaRaporuViewModelBase.futureController', context: context);
  ...
  late final _$_HareketDetayliYaslandirmaRaporuViewModelBaseActionController = ActionController(name: '_HareketDetayliYaslandirmaRaporuViewModelBase', context: context);

  @override
  void changeBakiyeDurumu(int? index) {
    final _$actionInfo = _$_HareketDetayliYaslandirmaRaporuViewModelBaseActionController.startAction(name: '_HareketDetayliYaslandirmaRaporuViewModelBase.changeBakiyeDurumu');
    try {
  ...
  @override
  void setFuture() {
    final _$actionInfo = _$_HareketDetayliYaslandirmaRaporuViewModelBaseActionController.startAction(name: '_HareketDetayliYaslandirmaRaporuViewModelBase.setFuture');
    try {
  ...
  @override
  void resetFuture() {
    final _$actionInfo = _$_HareketDetayliYaslandirmaRaporuViewModelBaseActionController.startAction(name: '_HareketDetayliYaslandirmaRaporuViewModelBase.resetFuture');
    try {
