...
mixin _$CariAktiviteDetayiViewModel on _CariAktiviteDetayiViewModelBase, Store {
  late final _$modelAtom = Atom(name: '_CariAktiviteDetayiViewModelBase.model', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_CariAktiviteDetayiViewModelBase.getData', context: context);
  ...
  void setModel(CariAktiviteListesiModel value) {
    ...
    try {
      ...
      _$_CariAktiviteDetayiViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
