...
class CariAktiviteFiltreDialogManager {
  static final BottomSheetDialogManager _bottomSheetDialogManager =
      BottomSheetDialogManager();
  static void showAktiviteDialog(BuildContext context) =>
      _bottomSheetDialogManager.showBottomSheetDialog(context,
          title: "title",
          body: Column(
