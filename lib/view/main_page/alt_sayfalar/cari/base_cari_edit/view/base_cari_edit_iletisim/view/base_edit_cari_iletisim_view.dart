...
final class _BaseCariEditIletisimViewState extends State<BaseCariEditIletisimView> {
  ...
  Widget build(BuildContext context) {
    if (_cariDetayModel.irtibatList.ext.isNullOrEmpty) {
      return const Center(child: Text("İletişim bilgisi bulunamadı"));
    }
      ...
      itemBuilder: (context, index) => Card(
        child: SizedBox(
          child: Column(
            ...
            children: <Widget>[
              Text(
                _cariDetayModel.irtibatList?[index].yetkiliKisi ?? "",
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: ColorPalette.slateGray.withValues(alpha: 0.5),
                      ),
                    ),
                  ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    flex: 3,
                    child: Text(_cariDetayModel.irtibatList?[index].emailSplit?.replaceAll(";", "\n") ?? ""),
                  ),
                ],
              ),
            ],
