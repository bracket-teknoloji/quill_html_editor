...
_$EBelgeListesiModelImpl _$$EBelgeListesiModelImplFromJson(Map<String, dynamic> json) => _$EBelgeListesiModelImpl(
  ...
  kayitTarihi: json['KAYIT_TARIHI'] == null ? null : DateTime.parse(json['KAYIT_TARIHI'] as String),
  ...
  eirsBilgi: json['EIRS_BILGI'] == null
      ? null
      : EIrsaliyeBilgiModel.fromJson(json['EIRS_BILGI'] as Map<String, dynamic>),
);

Map<String, dynamic> _$$EBelgeListesiModelImplToJson(_$EBelgeListesiModelImpl instance) => <String, dynamic>{
  ...
  if (instance.basariylaGonderildi case final value?) 'BASARIYLA_GONDERILDI': value,
  ...
  if (instance.kayitTarihi?.toIso8601String() case final value?) 'KAYIT_TARIHI': value,
  if (instance.eFaturaIptalTarihi?.toIso8601String() case final value?) 'E_FATURA_IPTAL_TARIHI': value,
  ...
  if (instance.gelenEFatKontrolEdildi case final value?) 'GELEN_E_FAT_KONTROL_EDILDI': value,
  if (instance.gelenEFatKontrolAciklama case final value?) 'GELEN_E_FAT_KONTROL_ACIKLAMA': value,
  if (instance.gonderimSekliEPosta case final value?) 'GONDERIM_SEKLI_E_POSTA': value,
