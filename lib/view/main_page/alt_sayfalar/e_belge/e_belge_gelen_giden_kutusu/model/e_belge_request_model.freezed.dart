...
/// Adds pattern-matching-related methods to [EBelgeRequestModel].
extension EBelgeRequestModelPatterns on EBelgeRequestModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EBelgeRequestModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EBelgeRequestModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EBelgeRequestModel value)  $default,){
final _that = this;
switch (_that) {
case _EBelgeRequestModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EBelgeRequestModel value)?  $default,){
final _that = this;
switch (_that) {
case _EBelgeRequestModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? basimDurumu,  String? baslamaTarihi,  String? bitisTarihi,  String? eBelgeTuru,  String? islendi,  bool? kayitTarihineGore,  String? kontrolEdildi,  String? faturaYonu,  String? onayDurumu,  int? sayfa,  String? senaryo,  String? sirala,  bool? sorgulanmasin,  String? searchText,  String? taslak,  String? resmiBelgeNo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EBelgeRequestModel() when $default != null:
return $default(_that.basimDurumu,_that.baslamaTarihi,_that.bitisTarihi,_that.eBelgeTuru,_that.islendi,_that.kayitTarihineGore,_that.kontrolEdildi,_that.faturaYonu,_that.onayDurumu,_that.sayfa,_that.senaryo,_that.sirala,_that.sorgulanmasin,_that.searchText,_that.taslak,_that.resmiBelgeNo);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? basimDurumu,  String? baslamaTarihi,  String? bitisTarihi,  String? eBelgeTuru,  String? islendi,  bool? kayitTarihineGore,  String? kontrolEdildi,  String? faturaYonu,  String? onayDurumu,  int? sayfa,  String? senaryo,  String? sirala,  bool? sorgulanmasin,  String? searchText,  String? taslak,  String? resmiBelgeNo)  $default,) {final _that = this;
switch (_that) {
case _EBelgeRequestModel():
return $default(_that.basimDurumu,_that.baslamaTarihi,_that.bitisTarihi,_that.eBelgeTuru,_that.islendi,_that.kayitTarihineGore,_that.kontrolEdildi,_that.faturaYonu,_that.onayDurumu,_that.sayfa,_that.senaryo,_that.sirala,_that.sorgulanmasin,_that.searchText,_that.taslak,_that.resmiBelgeNo);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? basimDurumu,  String? baslamaTarihi,  String? bitisTarihi,  String? eBelgeTuru,  String? islendi,  bool? kayitTarihineGore,  String? kontrolEdildi,  String? faturaYonu,  String? onayDurumu,  int? sayfa,  String? senaryo,  String? sirala,  bool? sorgulanmasin,  String? searchText,  String? taslak,  String? resmiBelgeNo)?  $default,) {final _that = this;
switch (_that) {
case _EBelgeRequestModel() when $default != null:
return $default(_that.basimDurumu,_that.baslamaTarihi,_that.bitisTarihi,_that.eBelgeTuru,_that.islendi,_that.kayitTarihineGore,_that.kontrolEdildi,_that.faturaYonu,_that.onayDurumu,_that.sayfa,_that.senaryo,_that.sirala,_that.sorgulanmasin,_that.searchText,_that.taslak,_that.resmiBelgeNo);case _:
  return null;
