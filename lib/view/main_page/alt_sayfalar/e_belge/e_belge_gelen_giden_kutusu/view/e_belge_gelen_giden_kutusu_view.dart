          ...
          FooterButton(
            children: [
              ListTile(
                ...
                trailing: Observer(
                  builder: (_) => Text(
                    ((viewModel.paramData?["TOPLAM_KAYIT_SAYISI"] as double?) ?? 0.0).toIntIfDouble.toStringIfNotNull ??
                        "",
                  ),
                ),
              ),
          ...
          InkWell(
            ...
            child: Row(
              ...
              children: [
                ...
                Observer(
                  builder: (_) => Icon(viewModel.digerGoster ? Icons.arrow_drop_up_outlined : Icons.arrow_drop_down),
                ),
              ],
            ),
          ).paddingAll(UIHelper.lowSize),
                  ...
                  CustomWidgetWithLabel(
                    ...
                    child: Observer(
                      builder: (_) => SlideControllerWidget(
                        ...
                        filterOnChanged: (index) =>
                            viewModel.changeNetsisIslenme(viewModel.netsisIslenmeMap.values.toList()[index ?? 0]),
