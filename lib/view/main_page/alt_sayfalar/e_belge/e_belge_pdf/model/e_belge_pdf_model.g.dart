...
_EBelgePdfModel _$EBelgePdfModelFromJson(Map<String, dynamic> json) => _EBelgePdfModel(
  islemKodu: (json['ISLEM_KODU'] as num?)?.toInt(),
  fileModel: json['FileModel'] == null ? null : FileModel.fromJson(json['FileModel'] as Map<String, dynamic>),
);

Map<String, dynamic> _$EBelgePdfModelToJson(_EBelgePdfModel instance) => <String, dynamic>{
...
Map<String, dynamic> _$FileModelToJson(_FileModel instance) => <String, dynamic>{
  if (instance.byteData case final value?) 'BYTE_DATA': value,
  if (instance.uzanti case final value?) 'UZANTI': value,
  if (instance.dosyaTarihi?.toIso8601String() case final value?) 'DOSYA_TARIHI': value,
