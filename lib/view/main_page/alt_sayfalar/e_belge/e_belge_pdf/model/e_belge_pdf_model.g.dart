...
Map<String, dynamic> _$$EBelgePdfModelImplToJson(_$EBelgePdfModelImpl instance) => <String, dynamic>{
...
Map<String, dynamic> _$$FileModelImplToJson(_$FileModelImpl instance) => <String, dynamic>{
