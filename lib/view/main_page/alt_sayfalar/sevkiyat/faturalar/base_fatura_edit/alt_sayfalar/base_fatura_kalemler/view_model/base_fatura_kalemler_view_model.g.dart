...
mixin _$BaseFaturaKalemlerViewModel on BaseFaturaKalemlerViewModelBase, Store {
  ...
  late final _$BaseFaturaKalemlerViewModelBaseActionController = ActionController(name: 'BaseFaturaKalemlerViewModelBase', context: context);

  @override
  void removeAtKalemList(int index) {
    final _$actionInfo = _$BaseFaturaKalemlerViewModelBaseActionController.startAction(name: 'BaseFaturaKalemlerViewModelBase.removeAtKalemList');
    try {
  ...
  void updateKalemList() {
    final _$actionInfo = _$BaseFaturaKalemlerViewModelBaseActionController.startAction(name: 'BaseFaturaKalemlerViewModelBase.updateKalemList');
    try {
