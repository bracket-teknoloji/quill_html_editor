...
mixin _$DepoFarkRaporuViewModel on _DepoFarkRaporuViewModelBase, Store {
  ...
  late final _$sayimListesiAtom = Atom(name: '_DepoFarkRaporuViewModelBase.sayimListesi', context: context);
  ...
  late final _$searchBarAtom = Atom(name: '_DepoFarkRaporuViewModelBase.searchBar', context: context);
  ...
  late final _$searchTextAtom = Atom(name: '_DepoFarkRaporuViewModelBase.searchText', context: context);
  ...
  late final _$filtreTuruAtom = Atom(name: '_DepoFarkRaporuViewModelBase.filtreTuru', context: context);
  ...
  late final _$requestModelAtom = Atom(name: '_DepoFarkRaporuViewModelBase.requestModel', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_DepoFarkRaporuViewModelBase.getData', context: context);
