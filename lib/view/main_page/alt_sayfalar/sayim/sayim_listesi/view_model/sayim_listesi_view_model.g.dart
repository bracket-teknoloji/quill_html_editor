...
mixin _$SayimListesiViewModel on _SayimListesiViewModelBase, Store {
  late final _$sayimListAtom = Atom(name: '_SayimListesiViewModelBase.sayimList', context: context);
  ...
  late final _$grupKoduListAtom = Atom(name: '_SayimListesiViewModelBase.grupKoduList', context: context);
  ...
  late final _$filtreModelAtom = Atom(name: '_SayimListesiViewModelBase.filtreModel', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_SayimListesiViewModelBase.getData', context: context);
  ...
  late final _$postDataAsyncAction = AsyncAction('_SayimListesiViewModelBase.postData', context: context);
