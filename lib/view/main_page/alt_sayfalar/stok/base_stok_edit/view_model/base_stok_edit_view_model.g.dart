...
mixin _$BaseStokEditingViewModel on _BaseStokEditingViewModelBase, Store {
  late final _$stokListesiModelAtom = Atom(name: '_BaseStokEditingViewModelBase.stokListesiModel', context: context);
  ...
  late final _$isSuccessAtom = Atom(name: '_BaseStokEditingViewModelBase.isSuccess', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_BaseStokEditingViewModelBase.getData', context: context);
