...
import "../../barkod_tanimla/alt_sayfalar/barkod_kayitlari/model/barkod_tanimla_kayitlari_model.dart";
import "../../stok_liste/model/stok_listesi_model.dart";

part "save_stok_model.g.dart";

@JsonSerializable(explicitToJson: true)
final class SaveStokModel with NetworkManagerMixin {
  SaveStokModel();

  factory SaveStokModel.forDeleteBarkodModel(BarkodTanimlaKayitlariModel model) =>
      SaveStokModel()
  ...
  factory SaveStokModel.forBarkodTanimla(StokListesiModel model) =>
      SaveStokModel()
  ...
  factory SaveStokModel.fromStokListesiModel(StokListesiModel model) =>
      SaveStokModel()
        ..adi = model.stokAdi
        ..kodu = model.stokKodu
