...
class SeriListImplAdapter extends TypeAdapter<_$SeriListImpl> {
  ...
  bool operator ==(Object other) =>
      ...
      other is SeriListImplAdapter && runtimeType == other.runtimeType && typeId == other.typeId;
}
...
_$SeriListImpl _$$SeriListImplFromJson(Map<String, dynamic> json) => _$SeriListImpl(
  stokKodu: json['STOK_KODU'] as String?,
...
Map<String, dynamic> _$$SeriListImplToJson(_$SeriListImpl instance) => <String, dynamic>{
  if (instance.stokKodu case final value?) 'STOK_KODU': value,
