...
SaveStokModel _$SaveStokModelFromJson(Map<String, dynamic> json) => SaveStokModel()
  ...
  ..stokBarkodModel = json['StokBarkodModel'] == null
      ? null
      : BarkodTanimlaKayitlariModel.fromJson(json['StokBarkodModel'] as Map<String, dynamic>)
...
Map<String, dynamic> _$SaveStokModelToJson(SaveStokModel instance) => <String, dynamic>{
  ...
  if (instance.seriGiristeOtomatik case final value?) 'SERI_GIRISTE_OTOMATIK': value,
  ...
  if (instance.barkodTanimlamaIslemi case final value?) 'BARKOD_TANIMLAMA_ISLEMI': value,
  if (instance.yeniKayit case final value?) '_YeniKayit': value,
  if (instance.stokBarkodModel?.toJson() case final value?) 'StokBarkodModel': value,
