...
abstract class _LokalDepoBakiyeRaporuViewModelBase with Store {  @observable
  PdfModel pdfModel = PdfModel(raporOzelKod: "Rapor_StokLokalDepo", standart: true, dicParams: DicParams()..sifirHaric ="H");
   ...
   List<BottomSheetModel>? bottomSheetList = CacheManager.getAnaVeri()?.paramModel?.depoList
      ?.map((e) => BottomSheetModel(title: e.depoTanimi ?? "", description: e.depoKodu.toStringIfNull ?? "", onTap: ()=> Get.back(result: e.depoKodu.toStringIfNull)))
      .toList();
    @observable
