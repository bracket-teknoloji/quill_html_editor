...
mixin _$BarkodTanimlaKayitlariViewModel on _BarkodTanimlaKayitlariViewModelBase, Store {
  ...
  @override
  set barkodTanimlaKayitlari(ObservableList<BarkodTanimlaKayitlariModel>? value) {
    _$barkodTanimlaKayitlariAtom.reportWrite(value, super.barkodTanimlaKayitlari, () {
      super.barkodTanimlaKayitlari = value;
    });
  }

  late final _$requestModelAtom = Atom(name: '_BarkodTanimlaKayitlariViewModelBase.requestModel', context: context);
  ...
  late final _$deleteItemAsyncAction = AsyncAction('_BarkodTanimlaKayitlariViewModelBase.deleteItem', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_BarkodTanimlaKayitlariViewModelBase.getData', context: context);
  ...
  void setStokKodu(String? stokKodu) {
    ...
    try {
      ...
      _$_BarkodTanimlaKayitlariViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
