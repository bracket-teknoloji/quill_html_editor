...
abstract class _BarkodTanimlaKayitlariViewModelBase with Store, MobxNetworkMixin {
  ...
  @action
  Future<void> deleteItem(BarkodTanimlaKayitlariModel model) async {
    final result = await networkManager.dioPost(path: ApiUrls.saveStok, bodyModel: BarkodTanimlaKayitlariModel());
    if (result.isSuccess) {
      await getData();
    }
  }
