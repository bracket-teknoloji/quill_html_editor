...
mixin _$BarkodTanimlaViewModel on _BarkodTanimlaViewModelBase, Store {
  late final _$stokModelAtom = Atom(
    name: '_BarkodTanimlaViewModelBase.stokModel',
    context: context,
  );
  ...
  late final _$getStokAsyncAction = AsyncAction(
    '_BarkodTanimlaViewModelBase.getStok',
    context: context,
  );
  ...
  late final _$savesStokAsyncAction = AsyncAction(
    '_BarkodTanimlaViewModelBase.savesStok',
    context: context,
  );
