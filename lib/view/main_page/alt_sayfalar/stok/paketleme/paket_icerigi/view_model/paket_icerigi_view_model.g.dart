...
mixin _$PaketIcerigiViewModel on _PaketIcerigiViewModelBase, Store {
  ...
  late final _$observableListAtom = Atom(name: '_PaketIcerigiViewModelBase.observableList', context: context);
  ...
  late final _$requestModelAtom = Atom(name: '_PaketIcerigiViewModelBase.requestModel', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_PaketIcerigiViewModelBase.getData', context: context);
  ...
  late final _$deleteItemAsyncAction = AsyncAction('_PaketIcerigiViewModelBase.deleteItem', context: context);

  @override
  Future<GenericResponseModel<PaketIcerigiModel>> deleteItem({int? id, int? paketID}) {
    return _$deleteItemAsyncAction.run(() => super.deleteItem(id: id, paketID: paketID));
  }
