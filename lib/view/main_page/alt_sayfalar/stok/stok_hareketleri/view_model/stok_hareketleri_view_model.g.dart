...
mixin _$StokHareketleriViewModel on _StokHareketleriViewModelBase, Store {
  ...
  @override
  String get getArrHareketTuru =>
      (_$getArrHareketTuruComputed ??= Computed<String>(
        () => super.getArrHareketTuru,
        name: '_StokHareketleriViewModelBase.getArrHareketTuru',
      )).value;

  late final _$cariListesiModelAtom = Atom(
    name: '_StokHareketleriViewModelBase.cariListesiModel',
    context: context,
  );
  ...
  late final _$isSelectedAtom = Atom(
    name: '_StokHareketleriViewModelBase.isSelected',
    context: context,
  );
  ...
  set isSelectedGroupValue(int? value) {
    _$isSelectedGroupValueAtom.reportWrite(
      value,
      super.isSelectedGroupValue,
      () {
  ...
  late final _$hareketTuruMapAtom = Atom(
    name: '_StokHareketleriViewModelBase.hareketTuruMap',
    context: context,
  );
  ...
  set gizlenecekAlanlarList(List<({String name, String value})> value) {
    _$gizlenecekAlanlarListAtom.reportWrite(
      value,
      super.gizlenecekAlanlarList,
      () {
  ...
  late final _$hareketYonuListAtom = Atom(
    name: '_StokHareketleriViewModelBase.hareketYonuList',
    context: context,
  );
  ...
  late final _$arrHareketTuruAtom = Atom(
    name: '_StokHareketleriViewModelBase.arrHareketTuru',
    context: context,
  );
  ...
  late final _$dovizliFiyatAtom = Atom(
    name: '_StokHareketleriViewModelBase.dovizliFiyat',
    context: context,
  );
  ...
  late final _$siralamaAtom = Atom(
    name: '_StokHareketleriViewModelBase.siralama',
    context: context,
  );
  ...
  late final _$futureAtom = Atom(
    name: '_StokHareketleriViewModelBase.future',
    context: context,
  );
  ...
  late final _$searchBarAtom = Atom(
    name: '_StokHareketleriViewModelBase.searchBar',
    context: context,
  );
  ...
  late final _$stokHareketleriAtom = Atom(
    name: '_StokHareketleriViewModelBase.stokHareketleri',
    context: context,
  );
  ...
  set filteredStokHareketleri(List<StokHareketleriModel>? value) {
    _$filteredStokHareketleriAtom.reportWrite(
      value,
      super.filteredStokHareketleri,
      () {
