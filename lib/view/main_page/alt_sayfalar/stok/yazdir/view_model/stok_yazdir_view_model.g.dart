...
mixin _$StokYazdirViewModel on _StokYazdirViewModelBase, Store {
  ...
  set stokSecildigindeYazdir(bool value) {
    _$stokSecildigindeYazdirAtom.reportWrite(
      value,
      super.stokSecildigindeYazdir,
      () {
  ...
  set yaziciVeDizayniHatirla(bool value) {
    _$yaziciVeDizayniHatirlaAtom.reportWrite(
      value,
      super.yaziciVeDizayniHatirla,
      () {
  ...
  late final _$stokAdiAtom = Atom(
    name: '_StokYazdirViewModelBase.stokAdi',
    context: context,
  );
  ...
  late final _$showYapilandirmaAtom = Atom(
    name: '_StokYazdirViewModelBase.showYapilandirma',
    context: context,
  );
  ...
  late final _$stokListesiModelAtom = Atom(
    name: '_StokYazdirViewModelBase.stokListesiModel',
    context: context,
  );
  ...
  late final _$printModelAtom = Atom(
    name: '_StokYazdirViewModelBase.printModel',
    context: context,
  );
