...
class _StokListesiViewState extends BaseState<StokListesiView> {
  ...
  List<StokListesiModel>? get stokListesi => viewModel.stokListesi ?? <StokListesiModel>[];
  ...
  Widget build(BuildContext context) {
    ...
    kod5Controller.text = viewModel.kod5?.map((BaseGrupKoduModel e) => e.grupAdi).join(", ") ?? "";
    return Scaffold(
                                ...
                                builder: (_) => SwitchListTile.adaptive(
                                      ...
                                      onChanged: (bool value) {
                                        ...
                                        if (viewModel.resimleriGoster == "E") {
                                          ...
                                          viewModel.setStokListesi(null);
                                          viewModel.setImageMap(<String, MemoryImage>{});
                                          viewModel.resetSayfa();
                                          getData();
                                          Get.back();
                                        }
            ...
            child: ListView(
              ...
              children: <AppBarButton>[
                ...
                AppBarButton(
                    ...
                    onPressed: () async {
                      if (viewModel.grupKodlari.isEmptyOrNull) {
                        ...
                        final GenericResponseModel<NetworkManagerMixin> grupKodlari = await CariNetworkManager.getKod(name: GrupKoduEnum.STOK);
                              ...
                              CustomWidgetWithLabel(
                                ...
                                child: Observer(
                                    builder: (_) => SlideControllerWidget(
                                        ...
                                        filterOnChanged: (int? index) => viewModel.setSelectedWithIndex(index ?? 0),
                              ...
                              Row(
                                children: <Widget>[
                                                ...
                                                onTap: () async {
                                                  final result = await bottomSheetDialogManager.showCheckBoxBottomSheetDialog(
                                                    ...
                                                    children: viewModel.grupKodlari
                                                        .map((BaseGrupKoduModel e) => BottomSheetModel(
                                                              title: e.grupAdi ?? "",
                                                              value: e,
                                                            ))
                                                        .toList(),
                                                  ...
                                                  if (result != null && result is List) {
                                                    ...
                                                    grupKoduController.text = viewModel.grupKodu?.map((BaseGrupKoduModel e) => e.grupAdi).join(", ") ?? "";
                                                  }
                                                },
                                                suffixMore: true,
                                              ))),
                                  Expanded(
                                    ...
                                    onTap: () async {
                                      final List<BaseGrupKoduModel> grupKodlari = viewModel.grupKodlari.where((BaseGrupKoduModel element) => element.grupNo == 1).toList();
                                      final result = await bottomSheetDialogManager.showCheckBoxBottomSheetDialog(
                                        context,
                                        title: "Kod 1",
                                        children: grupKodlari.map((BaseGrupKoduModel e) => BottomSheetModel(title: e.grupAdi ?? "", value: e)).toList(),
                                      );
                                      if (result != null && result is List) {
                                        viewModel.changeArrKod1(result.whereType<BaseGrupKoduModel>().toList());
                                        kod1Controller.text = viewModel.kod1?.map((BaseGrupKoduModel e) => e.grupAdi).join(", ") ?? "";
                                      }
                                    },
                                  ))
                                ],
                              ...
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    ...
                                    onTap: () async {
                                      final List<BaseGrupKoduModel> grupKodlari = viewModel.grupKodlari.where((BaseGrupKoduModel element) => element.grupNo == 2).toList();
                                      final result = await bottomSheetDialogManager.showCheckBoxBottomSheetDialog(
                                        context,
                                        title: "Kod 2",
                                        children: grupKodlari.map((BaseGrupKoduModel e) => BottomSheetModel(title: e.grupAdi ?? "", value: e)).toList(),
                                      ...
                                      if (result != null && result is List) {
                                        ...
                                        kod2Controller.text = viewModel.kod2?.map((BaseGrupKoduModel e) => e.grupAdi).join(", ") ?? "";
                                      }
                                    },
                                  )),
                                  Expanded(
                                    ...
                                    onTap: () async {
                                      final List<BaseGrupKoduModel> grupKodlari = viewModel.grupKodlari.where((BaseGrupKoduModel element) => element.grupNo == 3).toList();
                                      final result = await bottomSheetDialogManager.showCheckBoxBottomSheetDialog(
                                        context,
                                        title: "Kod 3",
                                        children: grupKodlari.map((BaseGrupKoduModel e) => BottomSheetModel(title: e.grupAdi ?? "", value: e)).toList(),
                                      ...
                                      if (result != null && result is List) {
                                        ...
                                        kod3Controller.text = viewModel.kod3?.map((BaseGrupKoduModel e) => e.grupAdi).join(", ") ?? "";
                                      }
                                    },
                                  ))
                                ],
                              ...
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    ...
                                    onTap: () async {
                                      final List<BaseGrupKoduModel> grupKodlari = viewModel.grupKodlari.where((BaseGrupKoduModel element) => element.grupNo == 4).toList();
                                      final result = await bottomSheetDialogManager.showCheckBoxBottomSheetDialog(
                                        context,
                                        title: "Kod 4",
                                      ...
                                      if (result != null && result is List) {
                                        ...
                                        kod4Controller.text = viewModel.kod4?.map((BaseGrupKoduModel e) => e.grupAdi).join(", ") ?? "";
                                      }
                                    },
                                  )),
                                  Expanded(
                                    ...
                                    onTap: () async {
                                      final List<BaseGrupKoduModel> grupKodlari = viewModel.grupKodlari.where((BaseGrupKoduModel element) => element.grupNo == 5).toList();
                                      final result = await bottomSheetDialogManager.showCheckBoxBottomSheetDialog(
                                        context,
                                        title: "Kod 5",
                                        children: grupKodlari
                ...
                AppBarButton(
                    ...
                    onPressed: () async {
                      final String? result = await bottomSheetDialogManager.showRadioBottomSheetDialog(context, title: "Sırala", children: <BottomSheetModel?>[
              ...
              ].map((AppBarButton e) => e.paddingAll(5)).toList(),
            ),
          ).paddingZero,
        ),
      );
                    ...
                    child: Listener(
                      ...
                      child: ListTile(
                        ...
                        onTap: (widget.isGetData ?? false)
                            ...
                            : () async {
                                final List<BottomSheetModel?> children2 = <BottomSheetModel?>[
                                  BottomSheetModel(
                                      title: "Görüntüle",
  ...
  Future<void> getData() async {
    final Map<String, Object> data2 = <String, Object>{
      "MenuKodu": "STOK_STOK",
    ...
    if (!viewModel.bottomSheetModel.arrGrupKodu.isEmptyOrNull) {
      final List<String> liste = <String>[];
      viewModel.bottomSheetModel.arrGrupKodu?.forEach((BaseGrupKoduModel element) {
    ...
    if (!viewModel.bottomSheetModel.arrKod1.isEmptyOrNull) {
      final List<String> liste = <String>[];
      viewModel.bottomSheetModel.arrKod1?.forEach((BaseGrupKoduModel element) {
        liste.add(element.grupKodu ?? "");
      });
      data2["ArrKod1"] = liste;
    }
    if (!viewModel.bottomSheetModel.arrKod2.isEmptyOrNull) {
      final List<String> liste = <String>[];
      viewModel.bottomSheetModel.arrKod2?.forEach((BaseGrupKoduModel element) {
        liste.add(element.grupKodu ?? "");
      });
      data2["ArrKod2"] = liste;
    }
    if (!viewModel.bottomSheetModel.arrKod3.isEmptyOrNull) {
      final List<String> liste = <String>[];
      viewModel.bottomSheetModel.arrKod3?.forEach((BaseGrupKoduModel element) {
        liste.add(element.grupKodu ?? "");
      });
      data2["ArrKod3"] = liste;
    }
    if (!viewModel.bottomSheetModel.arrKod4.isEmptyOrNull) {
      final List<String> liste = <String>[];
      viewModel.bottomSheetModel.arrKod4?.forEach((BaseGrupKoduModel element) {
        liste.add(element.grupKodu ?? "");
      });
      data2["ArrKod4"] = liste;
    }
    if (!viewModel.bottomSheetModel.arrKod5.isEmptyOrNull) {
      final List<String> liste = <String>[];
      viewModel.bottomSheetModel.arrKod5?.forEach((BaseGrupKoduModel element) {
        liste.add(element.grupKodu ?? "");
      });
      data2["ArrKod5"] = liste;
    }
    ...
    if (response.success ?? false) {
      final Map<String, MemoryImage> imageMap = <String, MemoryImage>{};
      ...
      if (viewModel.sayfa == 1) {
        for (StokListesiModel stokKaydi in liste ?? <StokListesiModel>[]) {
  ...
  Future<void> deleteStok(String stokKodu) async {
    await dialogManager.showAreYouSureDialog(() async {
      Get.back();
      final GenericResponseModel response = await networkManager.dioPost<StokListesiModel>(bodyModel: StokListesiModel(), path: ApiUrls.deleteStok, queryParameters: <String, dynamic>{"Kod": stokKodu});
      if (response.success ?? false) {
