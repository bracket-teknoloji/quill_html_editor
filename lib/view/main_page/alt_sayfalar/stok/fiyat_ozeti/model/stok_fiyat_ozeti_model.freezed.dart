...
StokFiyatOzetiModel _$StokFiyatOzetiModelFromJson(Map<String, dynamic> json) {
  return _StokFiyatOzetiModel.fromJson(json);
}
...
mixin _$StokFiyatOzetiModel {
  ...
  $StokFiyatOzetiModelCopyWith<StokFiyatOzetiModel> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $StokFiyatOzetiModelCopyWith<$Res> {
  factory $StokFiyatOzetiModelCopyWith(StokFiyatOzetiModel value, $Res Function(StokFiyatOzetiModel) then) =
      _$StokFiyatOzetiModelCopyWithImpl<$Res, StokFiyatOzetiModel>;
  @useResult
  $Res call({
    int? sira,
    String? grup,
...
/// @nodoc
class _$StokFiyatOzetiModelCopyWithImpl<$Res, $Val extends StokFiyatOzetiModel>
    implements $StokFiyatOzetiModelCopyWith<$Res> {
  _$StokFiyatOzetiModelCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? dovizFiyati = freezed,
    Object? dovizAdi = freezed,
    Object? dovizTipi = freezed,
    Object? brutFiyat = freezed,
...
/// @nodoc
abstract class _$$StokFiyatOzetiModelImplCopyWith<$Res> implements $StokFiyatOzetiModelCopyWith<$Res> {
  factory _$$StokFiyatOzetiModelImplCopyWith(
    _$StokFiyatOzetiModelImpl value,
    $Res Function(_$StokFiyatOzetiModelImpl) then,
  ) = __$$StokFiyatOzetiModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    int? sira,
...
/// @nodoc
class __$$StokFiyatOzetiModelImplCopyWithImpl<$Res>
    extends _$StokFiyatOzetiModelCopyWithImpl<$Res, _$StokFiyatOzetiModelImpl>
    implements _$$StokFiyatOzetiModelImplCopyWith<$Res> {
  __$$StokFiyatOzetiModelImplCopyWithImpl(
    _$StokFiyatOzetiModelImpl _value,
...
/// @nodoc
@JsonSerializable()
class _$StokFiyatOzetiModelImpl extends _StokFiyatOzetiModel {
  const _$StokFiyatOzetiModelImpl({
    this.sira,
    this.grup,
    this.tip,
    this.cariKodu,
    ...
    this.dovizTipi,
    this.brutFiyat,
    this.brutDovizFiyati,
  }) : super._();

  factory _$StokFiyatOzetiModelImpl.fromJson(Map<String, dynamic> json) => _$$StokFiyatOzetiModelImplFromJson(json);
  ...
  _$$StokFiyatOzetiModelImplCopyWith<_$StokFiyatOzetiModelImpl> get copyWith =>
      __$$StokFiyatOzetiModelImplCopyWithImpl<_$StokFiyatOzetiModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$StokFiyatOzetiModelImplToJson(this);
  }
}

abstract class _StokFiyatOzetiModel extends StokFiyatOzetiModel {
  const factory _StokFiyatOzetiModel({
    final int? sira,
    final String? grup,
    final String? tip,
    final String? cariKodu,
  ...
  factory _StokFiyatOzetiModel.fromJson(Map<String, dynamic> json) = _$StokFiyatOzetiModelImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$StokFiyatOzetiModelImplCopyWith<_$StokFiyatOzetiModelImpl> get copyWith => throw _privateConstructorUsedError;
}
