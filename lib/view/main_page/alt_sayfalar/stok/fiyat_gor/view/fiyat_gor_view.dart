...
class _FiyatGorViewState extends BaseState<FiyatGorView> {
          ...
          child: Column(
            ...
            children: <Widget>[
              CustomTextField(
                ...
                onSubmitted: (String p0) async => await getData(),
              ),
              Observer(
                  ...
                  builder: (_) => viewModel.modelList != null
                      ? (viewModel.modelList?.isEmpty ?? true)
                          ...
                          : Column(
                              ...
                              ].map((Card e) => Container(decoration: BoxDecoration(borderRadius: UIHelper.lowBorderRadius), child: e)).toList(),
                            )
                      : const SizedBox())
            ],
          ),
  ...
  Future<void> getData() async {
    ...
    final GenericResponseModel<NetworkManagerMixin> result =
        await networkManager.dioPost<FiyatGorModel>(path: ApiUrls.getFiyatGorFiyatlari, bodyModel: FiyatGorModel(), data: <String, String>{"StokKodu": barkodKontroller.text});
