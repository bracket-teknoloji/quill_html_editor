...
mixin _$FiyatGorViewModel on _FiyatGorViewModelBase, Store {
  late final _$modelListAtom = Atom(name: '_FiyatGorViewModelBase.modelList', context: context);
  ...
  late final _$stokListesiModelAtom = Atom(name: '_FiyatGorViewModelBase.stokListesiModel', context: context);
  ...
  late final _$_FiyatGorViewModelBaseActionController = ActionController(name: '_FiyatGorViewModelBase', context: context);

  @override
  void setStokListesiModel(StokListesiModel? model) {
    final _$actionInfo = _$_FiyatGorViewModelBaseActionController.startAction(name: '_FiyatGorViewModelBase.setStokListesiModel');
    try {
  ...
  void setModelList(List<FiyatGorModel?>? modelList) {
    final _$actionInfo = _$_FiyatGorViewModelBaseActionController.startAction(name: '_FiyatGorViewModelBase.setModelList');
    try {
  ...
  String? getBilgi(int index, {bool isSatis = false}) {
    final _$actionInfo = _$_FiyatGorViewModelBaseActionController.startAction(name: '_FiyatGorViewModelBase.getBilgi');
    try {
