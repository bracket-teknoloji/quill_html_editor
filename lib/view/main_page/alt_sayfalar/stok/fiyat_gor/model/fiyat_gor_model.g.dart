...
FiyatGorModel _$FiyatGorModelFromJson(Map<String, dynamic> json) => FiyatGorModel()
...
Map<String, dynamic> _$FiyatGorModelToJson(FiyatGorModel instance) => <String, dynamic>{
