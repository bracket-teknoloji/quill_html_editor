...
mixin _$StokYeniKayitViewModel on _StokYeniKayitViewModelBase, Store {
  late final _$projeListesiAtom = Atom(
    name: '_StokYeniKayitViewModelBase.projeListesi',
    context: context,
  );
  ...
  late final _$anaVeriAtom = Atom(
    name: '_StokYeniKayitViewModelBase.anaVeri',
    context: context,
  );
  ...
  late final _$modelAtom = Atom(
    name: '_StokYeniKayitViewModelBase.model',
    context: context,
  );
  ...
  late final _$isSelectedAtom = Atom(
    name: '_StokYeniKayitViewModelBase.isSelected',
    context: context,
  );
