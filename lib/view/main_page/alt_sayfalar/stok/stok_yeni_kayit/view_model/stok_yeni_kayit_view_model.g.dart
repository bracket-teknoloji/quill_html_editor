...
mixin _$StokYeniKayitViewModel on _StokYeniKayitViewModelBase, Store {
  ...
  late final _$_StokYeniKayitViewModelBaseActionController = ActionController(name: '_StokYeniKayitViewModelBase', context: context);

  @override
  void setProjeListesi(List<BaseProjeModel>? model) {
    final _$actionInfo = _$_StokYeniKayitViewModelBaseActionController.startAction(name: '_StokYeniKayitViewModelBase.setProjeListesi');
    try {
  ...
  void setStokKodu(String? value) {
    final _$actionInfo = _$_StokYeniKayitViewModelBaseActionController.startAction(name: '_StokYeniKayitViewModelBase.setStokKodu');
    try {
  ...
  void changeIsSelected(int index) {
    final _$actionInfo = _$_StokYeniKayitViewModelBaseActionController.startAction(name: '_StokYeniKayitViewModelBase.changeIsSelected');
    try {
