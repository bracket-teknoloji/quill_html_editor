...
class SerbestRaporResponseModel with NetworkManagerMixin {
  ...
  bool get plasiyerKoduMu => <String>["KOD", "KODU", "PLASIYER", "PLASIYERKOD", "PLASIYER_KOD", "PLASIYERKODU", "PLASIYER_KODU"].contains(rehberTipi);

  bool get cariKoduMu => <String>["KOD", "KODU", "CARI", "CARIKOD", "CARI_KOD", "CARIKODU", "CARI_KODU"].contains(rehberTipi);

  bool get stokKoduMu => <String>["KOD", "KODU", "STOK", "STOKKOD", "STOK_KOD", "STOKKODU", "STOK_KODU"].contains(rehberTipi);
