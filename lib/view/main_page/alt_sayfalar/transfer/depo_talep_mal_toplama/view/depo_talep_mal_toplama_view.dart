            ...
            child: Observer(
              builder: (_) => RefreshableListView(
                ...
                itemBuilder: (item) => Card(
                  child: ListTile(
                    onTap: () async {
                      if (viewModel.depoList == null) {
                        dialogManager.showAlertDialog("Depo seçiniz.");
                        return;
                      }
                      final result =
                          await Get.toNamed("mainPage/depoMalToplamaKalemEkle", arguments: item.copyWith(depoKodu: viewModel.depoList?.depoKodu, depoTanimi: viewModel.depoList?.depoTanimi));
                          ...
                          children: [
                            BottomSheetModel(
                              ...
                              onTap: () async {
                                Get
                                  ..back()
                                  ..toNamed("mainPage/transferTalepToplananlar", arguments: item);
                                await viewModel.getKalemler();
                              },
                            ),
                            BottomSheetModel(
