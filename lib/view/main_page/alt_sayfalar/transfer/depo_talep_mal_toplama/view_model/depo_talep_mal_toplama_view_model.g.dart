...
mixin _$DepoTalepMalToplamaViewModel on _DepoTalepMalToplamaViewModelBase, Store {
  late final _$modelAtom = Atom(name: '_DepoTalepMalToplamaViewModelBase.model', context: context);
  ...
  late final _$depoListAtom = Atom(name: '_DepoTalepMalToplamaViewModelBase.depoList', context: context);
  ...
  late final _$getKalemlerAsyncAction = AsyncAction('_DepoTalepMalToplamaViewModelBase.getKalemler', context: context);
  ...
  late final _$saveKalemAsyncAction = AsyncAction('_DepoTalepMalToplamaViewModelBase.saveKalem', context: context);
  ...
  void setModel(BaseSiparisEditModel value) {
    ...
    try {
      ...
      _$_DepoTalepMalToplamaViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
