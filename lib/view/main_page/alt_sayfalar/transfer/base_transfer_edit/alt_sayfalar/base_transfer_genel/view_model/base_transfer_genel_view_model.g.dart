...
part of 'base_transfer_genel_view_model.dart';
...
mixin _$BaseTransferGenelViewModel on _BaseTransferGenelViewModelBase, Store {
  late final _$kdvDahilAtom = Atom(name: '_BaseTransferGenelViewModelBase.kdvDahil', context: context);
  ...
  late final _$modelAtom = Atom(name: '_BaseTransferGenelViewModelBase.model', context: context);
