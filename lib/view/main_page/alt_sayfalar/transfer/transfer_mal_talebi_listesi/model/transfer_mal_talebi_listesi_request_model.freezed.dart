...
/// Adds pattern-matching-related methods to [TransferMalTalebiListesiRequestModel].
extension TransferMalTalebiListesiRequestModelPatterns on TransferMalTalebiListesiRequestModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TransferMalTalebiListesiRequestModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TransferMalTalebiListesiRequestModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TransferMalTalebiListesiRequestModel value)  $default,){
final _that = this;
switch (_that) {
case _TransferMalTalebiListesiRequestModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TransferMalTalebiListesiRequestModel value)?  $default,){
final _that = this;
switch (_that) {
case _TransferMalTalebiListesiRequestModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? durum,  List<int>? filtreler)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransferMalTalebiListesiRequestModel() when $default != null:
return $default(_that.durum,_that.filtreler);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? durum,  List<int>? filtreler)  $default,) {final _that = this;
switch (_that) {
case _TransferMalTalebiListesiRequestModel():
return $default(_that.durum,_that.filtreler);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? durum,  List<int>? filtreler)?  $default,) {final _that = this;
switch (_that) {
case _TransferMalTalebiListesiRequestModel() when $default != null:
return $default(_that.durum,_that.filtreler);case _:
  return null;
