...
class TransferMalTalebiListesiRequestModel with _$TransferMalTalebiListesiRequestModel {
  const factory TransferMalTalebiListesiRequestModel({
    String? durum,
    List<int>? filtreler,
  }) = _TransferMalTalebiListesiRequestModel;

  factory TransferMalTalebiListesiRequestModel.fromJson(Map<String, dynamic> json) => _$TransferMalTalebiListesiRequestModelFromJson(json);
}
