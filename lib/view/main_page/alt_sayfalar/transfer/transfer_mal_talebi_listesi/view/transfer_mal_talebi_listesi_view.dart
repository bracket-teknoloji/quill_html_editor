  ...
  CustomFloatingActionButton fab() => CustomFloatingActionButton(
    ...
    onPressed: () async {
      final result = await Get.toNamed(
        "mainPage/transferMalTalebiEdit",
        arguments: BaseEditModel<BaseSiparisEditModel>(baseEditEnum: BaseEditEnum.ekle),
      );
      if (result == true) {
        await viewModel.resetList();
      }
            ...
            BottomSheetModel(
              ...
              onTap: () async {
                Get
                  ...
                  ..toNamed(
                    "mainPage/transferMalTalebiEdit",
                    arguments: BaseEditModel<BaseSiparisEditModel>(baseEditEnum: BaseEditEnum.goruntule, model: item),
                  );
              },
            ),
            BottomSheetModel(
              ...
              onTap: () async {
                ...
                final result = await Get.toNamed(
                  "mainPage/transferMalTalebiEdit",
                  arguments: BaseEditModel<BaseSiparisEditModel>(baseEditEnum: BaseEditEnum.duzenle, model: item),
                );
                if (result == true) {
                  await viewModel.resetList();
                }
