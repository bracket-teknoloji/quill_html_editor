...
mixin _$DepoTalepKalemDetayViewModel
  ...
  void setModel(KalemModel value) {
    final _$actionInfo = _$_DepoTalepKalemDetayViewModelBaseActionController
        .startAction(name: '_DepoTalepKalemDetayViewModelBase.setModel');
    try {
  ...
  void setOlcuBirimi(({String? adi, int? kodu}) value) {
    final _$actionInfo = _$_DepoTalepKalemDetayViewModelBaseActionController
        .startAction(name: '_DepoTalepKalemDetayViewModelBase.setOlcuBirimi');
    try {
  ...
  void setMiktar(double? value) {
    final _$actionInfo = _$_DepoTalepKalemDetayViewModelBaseActionController
        .startAction(name: '_DepoTalepKalemDetayViewModelBase.setMiktar');
    try {
  ...
  void setAciklama(String value) {
    final _$actionInfo = _$_DepoTalepKalemDetayViewModelBaseActionController
        .startAction(name: '_DepoTalepKalemDetayViewModelBase.setAciklama');
    try {
