...
mixin _$DepoTalepKalemDetayViewModel on _DepoTalepKalemDetayViewModelBase, Store {
  late final _$modelAtom = Atom(name: '_DepoTalepKalemDetayViewModelBase.model', context: context);
  ...
  late final _$saveAsyncAction = AsyncAction('_DepoTalepKalemDetayViewModelBase.save', context: context);
  ...
  void setModel(KalemModel value) {
    ...
    try {
      ...
      _$_DepoTalepKalemDetayViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
