...
mixin _$TransferMalTalebiGenelViewModel
  ...
  void setModel(BaseSiparisEditModel value) {
    final _$actionInfo = _$_TransferMalTalebiGenelViewModelBaseActionController
        .startAction(name: '_TransferMalTalebiGenelViewModelBase.setModel');
    try {
  ...
  void setAciklama(String? value) {
    final _$actionInfo = _$_TransferMalTalebiGenelViewModelBaseActionController
        .startAction(name: '_TransferMalTalebiGenelViewModelBase.setAciklama');
    try {
  ...
  void setHedefSube(SubeList? value) {
    final _$actionInfo = _$_TransferMalTalebiGenelViewModelBaseActionController
        .startAction(name: '_TransferMalTalebiGenelViewModelBase.setHedefSube');
    try {
  ...
  void setDepoKodu(DepoList? value) {
    final _$actionInfo = _$_TransferMalTalebiGenelViewModelBaseActionController
        .startAction(name: '_TransferMalTalebiGenelViewModelBase.setDepoKodu');
    try {
  ...
  void setIsEmri(IsEmirleriModel? value) {
    final _$actionInfo = _$_TransferMalTalebiGenelViewModelBaseActionController
        .startAction(name: '_TransferMalTalebiGenelViewModelBase.setIsEmri');
    try {
