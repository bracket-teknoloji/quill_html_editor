...
mixin _$IrsaliyeFaturalastirViewModel on _IrsaliyeFaturalastirViewModelBase, Store {
  late final _$requestModelAtom = Atom(name: '_IrsaliyeFaturalastirViewModelBase.requestModel', context: context);
  ...
  late final _$modelAtom = Atom(name: '_IrsaliyeFaturalastirViewModelBase.model', context: context);
  ...
  Future<String?> getSiradakiBelgeNo(EditTipiEnum value, String? seri) {
    return _$getSiradakiBelgeNoAsyncAction.run(() => super.getSiradakiBelgeNo(value, seri));
  }

  late final _$sendFaturaAsyncAction = AsyncAction('_IrsaliyeFaturalastirViewModelBase.sendFatura', context: context);
  ...
  void setBasiSiparisEditModel(BaseSiparisEditModel? value) {
    ...
    try {
      ...
      _$_IrsaliyeFaturalastirViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
