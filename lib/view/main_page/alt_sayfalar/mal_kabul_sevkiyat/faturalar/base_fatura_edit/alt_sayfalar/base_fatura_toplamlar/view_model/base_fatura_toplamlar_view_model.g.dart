...
mixin _$BaseFaturaToplamlarViewModel on _BaseFaturaToplamlarViewModelBase, Store {
  ...
  void setSenaryo(String? value) {
    final _$actionInfo = _$_BaseFaturaToplamlarViewModelBaseActionController.startAction(name: '_BaseFaturaToplamlarViewModelBase.setSenaryo');
    try {
  ...
  void setEfatOzelkod(int? value) {
    final _$actionInfo = _$_BaseFaturaToplamlarViewModelBaseActionController.startAction(name: '_BaseFaturaToplamlarViewModelBase.setEfatOzelkod');
    try {
