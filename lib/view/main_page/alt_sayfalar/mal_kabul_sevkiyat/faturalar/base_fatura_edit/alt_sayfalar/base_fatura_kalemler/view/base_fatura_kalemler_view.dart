        ...
        if (!widget.model.isGoruntule)
          CustomTextField(
            ...
            onSubmitted: (p0) async {
              ...
              //   StokRehberiRequestModel(stokKodu: p0, okutuldu: true),
              // );
              // if (stokModel != null) {
              //   await Get.toNamed("/kalemEkle", arguments: stokModel..okutulanBarkod = p0);
              // } else {
              //   if (model.getEditTipiEnum?.rehberdenStokSecilsin ?? false) {
              //     await Get.toNamed("/mainPage/stokRehberi", arguments: p0);
              //   } else {
              //     dialogManager.showErrorSnackBar("$p0 numaralı stok bulunamadı.");
              //   }
              // }
            },
                  ...
                  TextSpan(
                    children: [
                      if (kalemModel.brutFiyat != null) ...[
                        TextSpan(
                          text: "Fiyat: ${kalemModel.brutFiyat.commaSeparatedWithDecimalDigits(OndalikEnum.tutar)}",
                        ),
              ...
              if (model.getEditTipiEnum?.fiyatGor == true && kalemModel.brutFiyat != null)
                Text.rich(
                  TextSpan(
                    children: [
                      TextSpan(
                        text: "Tutar: ${kalemModel.getBrutTutar.commaSeparatedWithDecimalDigits(OndalikEnum.tutar)}",
                      ),
                      if (kalemModel.dovizliMi)
                        TextSpan(
                          text:
            ...
            onTap: () async {
              ...
              if (result is SaveStokModel) {
                BaseSiparisEditModel.instance.kalemList?[index] = viewModel.kalemList![index].copyWith(
                  ...
                  kdvOrani: BaseSiparisEditModel.instance.getEditTipiEnum?.satisMi == true
