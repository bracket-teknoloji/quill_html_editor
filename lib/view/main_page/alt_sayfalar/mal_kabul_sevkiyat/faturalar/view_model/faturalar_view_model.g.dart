...
mixin _$FaturalarViewModel on _FaturalarViewModelBase, Store {
  ...
  late final _$kodlariGosterAtom = Atom(
    name: '_FaturalarViewModelBase.kodlariGoster',
    context: context,
  );
  ...
  late final _$editTipiEnumAtom = Atom(
    name: '_FaturalarViewModelBase.editTipiEnum',
    context: context,
  );
  ...
  set editTipiEnum(EditTipiEnum value) {
    _$editTipiEnumAtom.reportWrite(
      value,
      _editTipiEnumIsInitialized ? super.editTipiEnum : null,
      () {
  ...
  late final _$ekstraAlanlarMapAtom = Atom(
    name: '_FaturalarViewModelBase.ekstraAlanlarMap',
    context: context,
  );
  ...
  late final _$faturaRequestModelAtom = Atom(
    name: '_FaturalarViewModelBase.faturaRequestModel',
    context: context,
  );
  ...
  late final _$paramDataAtom = Atom(
    name: '_FaturalarViewModelBase.paramData',
    context: context,
  );
  ...
  late final _$isScrollDownAtom = Atom(
    name: '_FaturalarViewModelBase.isScrollDown',
    context: context,
  );
  ...
  late final _$grupKodlariGosterAtom = Atom(
    name: '_FaturalarViewModelBase.grupKodlariGoster',
    context: context,
  );
  ...
  late final _$observableListAtom = Atom(
    name: '_FaturalarViewModelBase.observableList',
    context: context,
  );
  ...
  late final _$grupKodListAtom = Atom(
    name: '_FaturalarViewModelBase.grupKodList',
    context: context,
  );
  ...
  late final _$isSearchBarOpenAtom = Atom(
    name: '_FaturalarViewModelBase.isSearchBarOpen',
    context: context,
  );
  ...
  late final _$searchTextAtom = Atom(
    name: '_FaturalarViewModelBase.searchText',
    context: context,
  );
  ...
  late final _$changeSearchBarAsyncAction = AsyncAction(
    '_FaturalarViewModelBase.changeSearchBar',
    context: context,
  );
  ...
  late final _$resetListAsyncAction = AsyncAction(
    '_FaturalarViewModelBase.resetList',
    context: context,
  );
  ...
  late final _$getKodAsyncAction = AsyncAction(
    '_FaturalarViewModelBase.getKod',
    context: context,
  );
  ...
  late final _$getDataAsyncAction = AsyncAction(
    '_FaturalarViewModelBase.getData',
    context: context,
  );
