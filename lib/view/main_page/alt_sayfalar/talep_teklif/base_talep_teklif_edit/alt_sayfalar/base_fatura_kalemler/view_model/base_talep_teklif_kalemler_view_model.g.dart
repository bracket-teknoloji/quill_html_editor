...
mixin _$BaseTalepTeklifKalemlerViewModel on BaseTalepTeklifKalemlerViewModelBase, Store {
  ...
  late final _$BaseTalepTeklifKalemlerViewModelBaseActionController = ActionController(name: 'BaseTalepTeklifKalemlerViewModelBase', context: context);

  @override
  void removeAtKalemList(int index) {
    final _$actionInfo = _$BaseTalepTeklifKalemlerViewModelBaseActionController.startAction(name: 'BaseTalepTeklifKalemlerViewModelBase.removeAtKalemList');
    try {
  ...
  void updateKalemList() {
    final _$actionInfo = _$BaseTalepTeklifKalemlerViewModelBaseActionController.startAction(name: 'BaseTalepTeklifKalemlerViewModelBase.updateKalemList');
    try {
