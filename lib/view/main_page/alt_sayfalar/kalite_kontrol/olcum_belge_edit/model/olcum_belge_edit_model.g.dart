...
_OlcumBelgeEditModel _$OlcumBelgeEditModelFromJson(Map<String, dynamic> json) => _OlcumBelgeEditModel(
  ...
  belge: (json['BELGE'] as List<dynamic>?)?.map((e) => OlcumBelgeModel.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$OlcumBelgeEditModelToJson(
  ...
  if (instance.kayitOperatorKodu case final value?) 'KAYIT_OPERATOR_KODU': value,
  if (instance.belge?.map((e) => e.toJson()).toList() case final value?) 'BELGE': value,
  if (instance.olcumler?.map((e) => e.toJson()).toList() case final value?) 'OLCUMLER': value,
  if (instance.prosesler?.map((e) => e.toJson()).toList() case final value?) 'PROSESLER': value,
};

_OlcumBelgeModel _$OlcumBelgeModelFromJson(Map<String, dynamic> json) => _OlcumBelgeModel(
  belgeNo: json['BELGE_NO'] as String?,
  belgeTipi: json['BELGE_TIPI'] as String?,
  belgeSira: (json['BELGE_SIRA'] as num?)?.toInt(),
...
Map<String, dynamic> _$OlcumBelgeModelToJson(
  ...
  if (instance.kontrolPlaniVarmi case final value?) 'KONTROL_PLANI_VARMI': value,
  if (instance.yarimOlcumYapabilirmi case final value?) 'YARIM_OLCUM_YAPABILIRMI': value,
...
_OlcumOlcumlerModel _$OlcumOlcumlerModelFromJson(Map<String, dynamic> json) => _OlcumOlcumlerModel(
...
Map<String, dynamic> _$OlcumProsesModelToJson(_OlcumProsesModel instance) => <String, dynamic>{
  if (instance.id case final value?) 'ID': value,
  if (instance.sira case final value?) 'SIRA': value,
  ...
  if (instance.sartliKabulNedeni case final value?) 'SARTLI_KABUL_NEDENI': value,
  if (instance.sartliKabulNedeniAciklama case final value?) 'SARTLI_KABUL_NEDENI_ACIKLAMA': value,
  if (instance.olcumOperatorModelOperator case final value?) 'OLCUM_OPERATOR_MODEL_OPERATOR': value,
  if (instance.oncekiOlcudeSartlivarmi case final value?) 'ONCEKI_OLCUDE_SARTLIVARMI': value,
...
_OlcumEkleDetayModel _$OlcumEkleDetayModelFromJson(Map<String, dynamic> json) => _OlcumEkleDetayModel(
  deger: (json['DEGER'] as num?)?.toDouble(),
  detayId: (json['DETAY_ID'] as num?)?.toInt(),
  zaman: json['ZAMAN'] == null ? null : DateTime.parse(json['ZAMAN'] as String),
);
