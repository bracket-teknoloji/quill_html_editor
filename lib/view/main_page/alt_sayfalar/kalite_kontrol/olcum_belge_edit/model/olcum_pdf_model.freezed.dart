...
mixin _$OlcumPdfModel {
  ...
  $OlcumPdfModelCopyWith<OlcumPdfModel> get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OlcumPdfModelCopyWith<$Res> {
  factory $OlcumPdfModelCopyWith(OlcumPdfModel value, $Res Function(OlcumPdfModel) then) =
      _$OlcumPdfModelCopyWithImpl<$Res, OlcumPdfModel>;
  @useResult
  $Res call({String? stokKodu, String? yapkod, String? revno, DateTime? revtar, String? tur});
}

/// @nodoc
class _$OlcumPdfModelCopyWithImpl<$Res, $Val extends OlcumPdfModel> implements $OlcumPdfModelCopyWith<$Res> {
...
/// @nodoc
abstract class _$$OlcumPdfModelImplCopyWith<$Res> implements $OlcumPdfModelCopyWith<$Res> {
  factory _$$OlcumPdfModelImplCopyWith(_$OlcumPdfModelImpl value, $Res Function(_$OlcumPdfModelImpl) then) =
...
/// @nodoc
class __$$OlcumPdfModelImplCopyWithImpl<$Res> extends _$OlcumPdfModelCopyWithImpl<$Res, _$OlcumPdfModelImpl>
    implements _$$OlcumPdfModelImplCopyWith<$Res> {
  __$$OlcumPdfModelImplCopyWithImpl(_$OlcumPdfModelImpl _value, $Res Function(_$OlcumPdfModelImpl) _then)
    : super(_value, _then);
...
class _$OlcumPdfModelImpl extends _OlcumPdfModel {
  _$OlcumPdfModelImpl({this.stokKodu, this.yapkod, this.revno, this.revtar, this.tur}) : super._();

  factory _$OlcumPdfModelImpl.fromJson(Map<String, dynamic> json) => _$$OlcumPdfModelImplFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$OlcumPdfModelImplToJson(this);
  }
}
...
abstract class _OlcumPdfModel extends OlcumPdfModel {
  ...
  factory _OlcumPdfModel.fromJson(Map<String, dynamic> json) = _$OlcumPdfModelImpl.fromJson;
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  _$$OlcumPdfModelImplCopyWith<_$OlcumPdfModelImpl> get copyWith => throw _privateConstructorUsedError;
}
