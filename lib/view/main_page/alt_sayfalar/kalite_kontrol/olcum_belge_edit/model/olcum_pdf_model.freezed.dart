...
/// Adds pattern-matching-related methods to [OlcumPdfModel].
extension OlcumPdfModelPatterns on OlcumPdfModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OlcumPdfModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _OlcumPdfModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _OlcumPdfModel value)  $default,){
final _that = this;
switch (_that) {
case _OlcumPdfModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _OlcumPdfModel value)?  $default,){
final _that = this;
switch (_that) {
case _OlcumPdfModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? stokKodu,  String? yapkod,  String? revno,  DateTime? revtar,  String? tur)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OlcumPdfModel() when $default != null:
return $default(_that.stokKodu,_that.yapkod,_that.revno,_that.revtar,_that.tur);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? stokKodu,  String? yapkod,  String? revno,  DateTime? revtar,  String? tur)  $default,) {final _that = this;
switch (_that) {
case _OlcumPdfModel():
return $default(_that.stokKodu,_that.yapkod,_that.revno,_that.revtar,_that.tur);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? stokKodu,  String? yapkod,  String? revno,  DateTime? revtar,  String? tur)?  $default,) {final _that = this;
switch (_that) {
case _OlcumPdfModel() when $default != null:
return $default(_that.stokKodu,_that.yapkod,_that.revno,_that.revtar,_that.tur);case _:
  return null;
