...
_OlcumOperatorModel _$OlcumOperatorModelFromJson(Map<String, dynamic> json) => _OlcumOperatorModel(
...
Map<String, dynamic> _$OlcumOperatorModelToJson(_OlcumOperatorModel instance) => <String, dynamic>{
