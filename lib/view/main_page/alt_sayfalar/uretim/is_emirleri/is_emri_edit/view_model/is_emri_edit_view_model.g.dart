...
mixin _$IsEmriEditViewModel on _IsEmriEditViewModelBase, Store {
  late final _$modelAtom = Atom(name: '_IsEmriEditViewModelBase.model', context: context);
  ...
  late final _$getBelgeNoAsyncAction = AsyncAction('_IsEmriEditViewModelBase.getBelgeNo', context: context);
  ...
  late final _$sendDataAsyncAction = AsyncAction('_IsEmriEditViewModelBase.sendData', context: context);
  ...
  late final _$_IsEmriEditViewModelBaseActionController = ActionController(
    name: '_IsEmriEditViewModelBase',
    context: context,
  );
