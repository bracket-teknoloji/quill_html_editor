...
_$IsEmriHammaddeTakibiDetayModelImpl _$$IsEmriHammaddeTakibiDetayModelImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$IsEmriHammaddeTakibiDetayModelImplToJson(_$IsEmriHammaddeTakibiDetayModelImpl instance) =>
    <String, dynamic>{
...
_$ReferanslarImpl _$$ReferanslarImplFromJson(Map<String, dynamic> json) => _$ReferanslarImpl(
...
Map<String, dynamic> _$$ReferanslarImplToJson(_$ReferanslarImpl instance) => <String, dynamic>{
