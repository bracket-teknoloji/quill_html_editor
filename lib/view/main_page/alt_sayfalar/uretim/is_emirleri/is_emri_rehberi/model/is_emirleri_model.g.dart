...
_IsEmirleriModel _$IsEmirleriModelFromJson(Map<String, dynamic> json) => _IsEmirleriModel(
...
Map<String, dynamic> _$IsEmirleriModelToJson(_IsEmirleriModel instance) => <String, dynamic>{
