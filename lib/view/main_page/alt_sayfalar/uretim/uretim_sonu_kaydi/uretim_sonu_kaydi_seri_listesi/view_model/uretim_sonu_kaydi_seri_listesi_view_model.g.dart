...
mixin _$UretimSonuKaydiSeriListesiViewModel on _UretimSonuKaydiSeriListesiViewModelBase, Store {
  ...
  late final _$kalemModelAtom = Atom(name: '_UretimSonuKaydiSeriListesiViewModelBase.kalemModel', context: context);
  ...
  late final _$requestModelAtom = Atom(name: '_UretimSonuKaydiSeriListesiViewModelBase.requestModel', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_UretimSonuKaydiSeriListesiViewModelBase.getData', context: context);
  ...
  void setKalem(KalemModel? value) {
    ...
    try {
      ...
      _$_UretimSonuKaydiSeriListesiViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
