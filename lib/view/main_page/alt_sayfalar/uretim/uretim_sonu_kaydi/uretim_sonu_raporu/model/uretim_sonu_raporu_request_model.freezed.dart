...
UretimSonuRaporuRequestModel _$UretimSonuRaporuRequestModelFromJson(Map<String, dynamic> json) {
...
mixin _$UretimSonuRaporuRequestModel {
  ...
  $UretimSonuRaporuRequestModelCopyWith<UretimSonuRaporuRequestModel> get copyWith =>
...
abstract class $UretimSonuRaporuRequestModelCopyWith<$Res> {
  ...
  ) = _$UretimSonuRaporuRequestModelCopyWithImpl<$Res, UretimSonuRaporuRequestModel>;
  @useResult
  $Res call({String? belgeNo, int? filtreKodu, String? stokKodu});
}

/// @nodoc
class _$UretimSonuRaporuRequestModelCopyWithImpl<$Res, $Val extends UretimSonuRaporuRequestModel>
  ...
  @override
  $Res call({Object? belgeNo = freezed, Object? filtreKodu = freezed, Object? stokKodu = freezed}) {
    return _then(
      _value.copyWith(
...
class __$$UretimSonuRaporuRequestModelImplCopyWithImpl<$Res>
    extends _$UretimSonuRaporuRequestModelCopyWithImpl<$Res, _$UretimSonuRaporuRequestModelImpl>
...
class _$UretimSonuRaporuRequestModelImpl implements _UretimSonuRaporuRequestModel {
  _$UretimSonuRaporuRequestModelImpl({this.belgeNo, this.filtreKodu, this.stokKodu});

  factory _$UretimSonuRaporuRequestModelImpl.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UretimSonuRaporuRequestModelImplCopyWith<_$UretimSonuRaporuRequestModelImpl> get copyWith =>
      __$$UretimSonuRaporuRequestModelImplCopyWithImpl<_$UretimSonuRaporuRequestModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UretimSonuRaporuRequestModelImplToJson(this);
  }
}

abstract class _UretimSonuRaporuRequestModel implements UretimSonuRaporuRequestModel {
  factory _UretimSonuRaporuRequestModel({String? belgeNo, int? filtreKodu, String? stokKodu}) =
      _$UretimSonuRaporuRequestModelImpl;
