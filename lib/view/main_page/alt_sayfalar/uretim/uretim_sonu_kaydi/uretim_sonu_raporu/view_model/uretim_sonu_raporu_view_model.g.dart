...
mixin _$UretimSonuRaporuViewModel on _UretimSonuRaporuViewModelBase, Store {
  late final _$observableListAtom = Atom(name: '_UretimSonuRaporuViewModelBase.observableList', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_UretimSonuRaporuViewModelBase.getData', context: context);
