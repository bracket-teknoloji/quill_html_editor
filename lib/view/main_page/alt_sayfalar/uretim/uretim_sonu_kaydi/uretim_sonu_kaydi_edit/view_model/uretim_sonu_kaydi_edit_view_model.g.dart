...
mixin _$UretimSonuKaydiEditViewModel on _UretimSonuKaydiEditViewModelBase, Store {
  ...
  late final _$showSaveButtonAtom = Atom(name: '_UretimSonuKaydiEditViewModelBase.showSaveButton', context: context);
  ...
  late final _$modelAtom = Atom(name: '_UretimSonuKaydiEditViewModelBase.model', context: context);
  ...
  late final _$requestModelAtom = Atom(name: '_UretimSonuKaydiEditViewModelBase.requestModel', context: context);
  ...
  late final _$kalemListAtom = Atom(name: '_UretimSonuKaydiEditViewModelBase.kalemList', context: context);
  ...
  late final _$ekAlanlarListAtom = Atom(name: '_UretimSonuKaydiEditViewModelBase.ekAlanlarList', context: context);
  ...
  late final _$getKalemlerAsyncAction = AsyncAction('_UretimSonuKaydiEditViewModelBase.getKalemler', context: context);
  ...
  late final _$saveUSKAsyncAction = AsyncAction('_UretimSonuKaydiEditViewModelBase.saveUSK', context: context);
  ...
  void setBelgeNo(String? belgeNo) {
    ...
    try {
      ...
      _$_UretimSonuKaydiEditViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
