...
_$UretimSonuKaydiEditModelImpl _$$UretimSonuKaydiEditModelImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$UretimSonuKaydiEditModelImplToJson(_$UretimSonuKaydiEditModelImpl instance) =>
    <String, dynamic>{
...
_$EkAlanlarImpl _$$EkAlanlarImplFromJson(Map<String, dynamic> json) => _$EkAlanlarImpl(
  ktAlan1: json['KT_ALAN1'] as String?,
  ktAlan3: json['KT_ALAN3'] as String?,
  ktAlan4: json['KT_ALAN4'] as String?,
);

Map<String, dynamic> _$$EkAlanlarImplToJson(_$EkAlanlarImpl instance) => <String, dynamic>{
