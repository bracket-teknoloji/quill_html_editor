...
/// @nodoc
mixin _$UretimSonuKaydiEditModel {
  ...
  EkAlanlar? get ekAlanlar => throw _privateConstructorUsedError;
  @JsonKey(name: "EkAlanlar")
  set ekAlanlar(EkAlanlar? value) => throw _privateConstructorUsedError;
  ...
  String? get tarih => throw _privateConstructorUsedError;
  set tarih(String? value) => throw _privateConstructorUsedError;
...
class _$UretimSonuKaydiEditModelCopyWithImpl<$Res, $Val extends UretimSonuKaydiEditModel>
  ...
  @pragma('vm:prefer-inline')
  $EkAlanlarCopyWith<$Res>? get ekAlanlar {
    if (_value.ekAlanlar == null) {
      return null;
    }

    return $EkAlanlarCopyWith<$Res>(_value.ekAlanlar!, (value) {
      return _then(_value.copyWith(ekAlanlar: value) as $Val);
    });
  }
}
...
abstract class _UretimSonuKaydiEditModel extends UretimSonuKaydiEditModel {
  ...
  @override
  @JsonKey(name: "EkAlanlar")
  EkAlanlar? get ekAlanlar;
  @JsonKey(name: "EkAlanlar")
  set ekAlanlar(EkAlanlar? value);
  @override
  int? get girisDepo;
...
EkAlanlar _$EkAlanlarFromJson(Map<String, dynamic> json) {
  return _EkAlanlar.fromJson(json);
}
...
class _$EkAlanlarImpl extends _EkAlanlar {
  ...
  _$$EkAlanlarImplCopyWith<_$EkAlanlarImpl> get copyWith =>
      __$$EkAlanlarImplCopyWithImpl<_$EkAlanlarImpl>(this, _$identity);
