...
mixin _$UretimFireBilgileriViewModel on _UretimFireBilgileriViewModelBase, Store {
  late final _$modelAtom = Atom(name: '_UretimFireBilgileriViewModelBase.model', context: context);
  ...
  late final _$fireModelAtom = Atom(name: '_UretimFireBilgileriViewModelBase.fireModel', context: context);
  ...
  late final _$observableListAtom = Atom(name: '_UretimFireBilgileriViewModelBase.observableList', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_UretimFireBilgileriViewModelBase.getData', context: context);
  ...
  void addFireModel(KalemFireModel value) {
    ...
    try {
      ...
      _$_UretimFireBilgileriViewModelBaseActionController.endAction(_$actionInfo);
    }
  }
