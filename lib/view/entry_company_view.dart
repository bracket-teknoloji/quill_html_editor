...
class _EntryCompanyViewState extends BaseState<EntryCompanyView> {
  Map selected = {'Şirket': "", 'İşletme': "", 'Şube': ""};
  List? sirket;
  List? isletme;
  List? sube;
  ...
  Future<dynamic> getSirket({String? name}) async {
                      ...
                      child: Column(
                          ...
                          children: [
                            DropdownButtonFormField(
                              value: selected['Şirket'] == "" ? null : selected['Şirket'],
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (formKey.currentState!.validate()) {
                          ...
                          // };
                          final model = AccountModel.create()
                          ...
                          dialogManager.showCupertinoDialog(response.data.toString());
                        }
                      },
