...
mixin _$AddAccountViewModel on _AddAccountViewModelBase, Store {
  late final _$obscurePasswordAtom = Atom(name: '_AddAccountViewModelBase.obscurePassword', context: context);
  ...
  late final _$togglePasswordAsyncAction = AsyncAction('_AddAccountViewModelBase.togglePassword', context: context);
