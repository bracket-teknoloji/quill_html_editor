...
mixin _$SplashAuthViewModel on _SplashAuthViewModelBase, Store {
  late final _$titleAtom = Atom(
    name: '_SplashAuthViewModelBase.title',
    context: context,
  );
  ...
  late final _$isErrorAtom = Atom(
    name: '_SplashAuthViewModelBase.isError',
    context: context,
  );
  ...
  late final _$accountResponseModelAtom = Atom(
    name: '_SplashAuthViewModelBase.accountResponseModel',
    context: context,
  );
  ...
  set accountResponseModel(AccountResponseModel? value) {
    _$accountResponseModelAtom.reportWrite(
      value,
      super.accountResponseModel,
      () {
  ...
  late final _$_SplashAuthViewModelBaseActionController = ActionController(
    name: '_SplashAuthViewModelBase',
    context: context,
  );
