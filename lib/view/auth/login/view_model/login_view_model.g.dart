...
mixin _$LoginViewModel on _LoginViewModelBase, Store {
  late final _$obscurePasswordAtom = Atom(
    name: '_LoginViewModelBase.obscurePassword',
    context: context,
  );
  ...
  late final _$isDebugAtom = Atom(
    name: '_LoginViewModelBase.isDebug',
    context: context,
  );
  ...
  late final _$baglantiTipiAtom = Atom(
    name: '_LoginViewModelBase.baglantiTipi',
    context: context,
  );
