  ...
  ThemeData get theme => ThemeData(
    ...
    dropdownMenuTheme: DropdownMenuThemeData(
      inputDecorationTheme: InputDecorationTheme(
        ...
        errorBorder: OutlineInputBorder(borderRadius: UIHelper.midBorderRadius),
        border: OutlineInputBorder(borderRadius: UIHelper.midBorderRadius),
        enabledBorder: OutlineInputBorder(borderRadius: UIHelper.midBorderRadius),
        focusedBorder: OutlineInputBorder(borderRadius: UIHelper.midBorderRadius),
      ),
    ),
