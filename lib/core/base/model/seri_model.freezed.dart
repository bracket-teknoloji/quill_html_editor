...
/// Adds pattern-matching-related methods to [SeriModel].
extension SeriModelPatterns on SeriModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SeriModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SeriModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SeriModel value)  $default,){
final _that = this;
switch (_that) {
case _SeriModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SeriModel value)?  $default,){
final _that = this;
switch (_that) {
case _SeriModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? seriNo,  String? aciklama,  String? stokKodu,  String? stokAdi,  int? depoKodu,  int? miktar,  String? depoTanimi)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SeriModel() when $default != null:
return $default(_that.seriNo,_that.aciklama,_that.stokKodu,_that.stokAdi,_that.depoKodu,_that.miktar,_that.depoTanimi);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? seriNo,  String? aciklama,  String? stokKodu,  String? stokAdi,  int? depoKodu,  int? miktar,  String? depoTanimi)  $default,) {final _that = this;
switch (_that) {
case _SeriModel():
return $default(_that.seriNo,_that.aciklama,_that.stokKodu,_that.stokAdi,_that.depoKodu,_that.miktar,_that.depoTanimi);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? seriNo,  String? aciklama,  String? stokKodu,  String? stokAdi,  int? depoKodu,  int? miktar,  String? depoTanimi)?  $default,) {final _that = this;
switch (_that) {
case _SeriModel() when $default != null:
return $default(_that.seriNo,_that.aciklama,_that.stokKodu,_that.stokAdi,_that.depoKodu,_that.miktar,_that.depoTanimi);case _:
  return null;
