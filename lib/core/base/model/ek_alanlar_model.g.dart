...
_EkAlanlarModel _$EkAlanlarModelFromJson(Map<String, dynamic> json) => _EkAlanlarModel(
...
Map<String, dynamic> _$EkAlanlarModelToJson(_EkAlanlarModel instance) => <String, dynamic>{
