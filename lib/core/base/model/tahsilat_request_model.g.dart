...
Map<String, dynamic> _$TahsilatRequestModelToJson(
  ...
  if (instance.cariyiBorclandir case final value?) 'CARIYI_BORCLANDIR': value,
  ...
  if (instance.hedefHesapReferansKodu case final value?) 'HEDEF_HESAP_REFERANS_KODU': value,
  if (instance.kaynakHesapReferansKodu case final value?) 'KAYNAK_HESAP_REFERANS_KODU': value,
  if (instance.taksitSayisi case final value?) 'TAKSIT_SAYISI': value,
};

_DekontKalemler _$DekontKalemlerFromJson(Map<String, dynamic> json) => _DekontKalemler(
  aciklama: json['ACIKLAMA'] as String?,
  belgeNo: json['BELGE_NO'] as String?,
...
Map<String, dynamic> _$DekontKalemlerToJson(
  _DekontKalemler instance,
) => <String, dynamic>{
  if (instance.aciklama case final value?) 'ACIKLAMA': value,
  if (instance.belgeNo case final value?) 'BELGE_NO': value,
