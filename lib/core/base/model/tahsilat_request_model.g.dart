...
Map<String, dynamic> _$$TahsilatRequestModelImplToJson(_$TahsilatRequestModelImpl instance) => <String, dynamic>{
...
_$DekontKalemlerImpl _$$DekontKalemlerImplFromJson(Map<String, dynamic> json) => _$DekontKalemlerImpl(
  aciklama: json['ACIKLAMA'] as String?,
  belgeNo: json['BELGE_NO'] as String?,
...
Map<String, dynamic> _$$DekontKalemlerImplToJson(_$DekontKalemlerImpl instance) => <String, dynamic>{
  if (instance.aciklama case final value?) 'ACIKLAMA': value,
  if (instance.belgeNo case final value?) 'BELGE_NO': value,
