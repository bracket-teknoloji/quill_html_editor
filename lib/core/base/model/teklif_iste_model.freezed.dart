...
/// Adds pattern-matching-related methods to [TeklifIsteModel].
extension TeklifIsteModelPatterns on TeklifIsteModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TeklifIsteModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TeklifIsteModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TeklifIsteModel value)  $default,){
final _that = this;
switch (_that) {
case _TeklifIsteModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TeklifIsteModel value)?  $default,){
final _that = this;
switch (_that) {
case _TeklifIsteModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? tip,  String? mesaj)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TeklifIsteModel() when $default != null:
return $default(_that.tip,_that.mesaj);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? tip,  String? mesaj)  $default,) {final _that = this;
switch (_that) {
case _TeklifIsteModel():
return $default(_that.tip,_that.mesaj);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? tip,  String? mesaj)?  $default,) {final _that = this;
switch (_that) {
case _TeklifIsteModel() when $default != null:
return $default(_that.tip,_that.mesaj);case _:
  return null;
