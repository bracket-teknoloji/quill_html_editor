...
_TcmbBankalarModel _$TcmbBankalarModelFromJson(Map<String, dynamic> json) => _TcmbBankalarModel(
...
Map<String, dynamic> _$TcmbBankalarModelToJson(_TcmbBankalarModel instance) => <String, dynamic>{
