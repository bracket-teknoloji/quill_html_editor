...
import "../../../model/base_proje_model.dart";
...
class _KalemEkleViewState extends BaseState<KalemEkleView> {
          ...
          IconButton(
              onPressed: () async {
                await bottomSheetDialogManager.showBottomSheetDialog(context,
                    title: "Seçenekler", children: <BottomSheetModel>[BottomSheetModel(title: "Döviz Kurları", iconWidget: Icons.money_outlined, onTap: () => Get.toNamed("/dovizKurlari"))]);
              },
          ...
          IconButton(
              onPressed: () {
                if (formKey.currentState?.validate() ?? false) {
                  ...
                  viewModel.kalemModel.kalemList?.map((KalemModel e) => e.miktar = viewModel.kalemModel.miktar2).toList();
                  BaseSiparisEditModel.instance.kalemList ??= <KalemModel>[];
                  if (BaseSiparisEditModel.instance.kalemList?.any((KalemModel element) => element.stokKodu == viewModel.kalemModel.stokKodu) ?? false) {
                    //replace
                    BaseSiparisEditModel.instance.kalemList?[BaseSiparisEditModel.instance.kalemList?.indexWhere((KalemModel element) => element.stokKodu == viewModel.kalemModel.stokKodu) ?? 0] =
                          ...
                          Row(
                            children: <Widget>[
                              Expanded(
                                ...
                                TextSpan(text: viewModel.model?.stokKodu ?? "", style: const TextStyle(fontWeight: FontWeight.bold))
                              ]))),
                              Expanded(
                                  child: Text.rich(TextSpan(children: <InlineSpan>[
                          ...
                          Card(
                              ...
                              child: Center(
                                child: Text.rich(TextSpan(
                                        children: <InlineSpan>[const TextSpan(text: "Son Fiyat: "), TextSpan(text: "0,00 $mainCurrency", style: const TextStyle(fontWeight: FontWeight.bold))]))
                  ...
                  child: Column(
                    children: <Widget>[
                      Observer(
                          builder: (_) => Row(
                                children: <Widget>[
                                  Expanded(child: CustomTextField(labelText: "Kalem Adı", controller: kalemAdiController, onChanged: (String p0) => viewModel.kalemModel.stokAdi = p0)),
                                  Expanded(
                                      child: CustomTextField(
                                          ...
                                          onTap: () async {
                                            final StokMuhasebeKoduModel? result = await bottomSheetDialogManager.showMuhasebeKoduBottomSheetDialog(context);
                                            if (result != null) {
                      ...
                      CustomTextField(labelText: "Ek Alan 1", onChanged: (String p0) => viewModel.kalemModel.ekalan1 = p0).yetkiVarMi(yetkiController.siparisEkAlan1AktifMi),
                      CustomTextField(labelText: "Ek Alan 2", onChanged: (String p0) => viewModel.kalemModel.ekalan2 = p0).yetkiVarMi(yetkiController.siparisSatirdaEkAlan2AktifMi),
                      CustomTextField(
                          ...
                          onTap: () async {
                            final result = await Get.toNamed("/mainPage/yapilandirmaRehberi",
                        ...
                        children: <Widget>[
                          Expanded(
                              child: CustomTextField(
                                  ...
                                  suffix: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
                                    IconButton(
                                        onPressed: () async {
                                          final DateTime? result = await dialogManager.showDateTimePicker();
                                          if (result != null) {
                          ...
                          Expanded(
                            ...
                            onTap: () async {
                              final CariKosullarModel? result = await bottomSheetDialogManager.showKosullarBottomSheetDialog(context);
                              if (result != null) {
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Expanded(
                            ...
                            onTap: () async {
                              final DepoList? result = await bottomSheetDialogManager.showDepoBottomSheetDialog(context);
                              if (result != null) {
                          ...
                          Expanded(
                              child: Observer(
                                  builder: (_) => CustomTextField(
                                        ...
                                        onChanged: (String value) => viewModel.setMiktar(int.tryParse(value) ?? 0),
                          ...
                          Expanded(
                              child: Observer(
                                  builder: (_) => CustomTextField(
                                        ...
                                        onChanged: (String value) => viewModel.setMiktar2(int.tryParse(value) ?? 0),
                                        suffix: Wrap(children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Expanded(
                            ...
                            keyboardType: const TextInputType.numberWithOptions(decimal: true, signed: true),
                            isFormattedString: true,
                            onChanged: (String p0) => viewModel.setKdvOrani(p0.toDoubleWithFormattedString),
                            suffix: IconButton(
                              icon: const Icon(Icons.more_horiz_outlined),
                              onPressed: () async {
                                final double? result = await bottomSheetDialogManager.showKdvOranlariBottomSheetDialog(context);
                                if (result != null) {
                      ...
                      ...List.generate(
                          yetkiController.siparisSatirKademeliIskontoSayisi > 6 ? 6 : yetkiController.siparisSatirKademeliIskontoSayisi,
                          (int index) => Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  Expanded(
                                      child: CustomTextField(
                                          ...
                                          suffix: yetkiController.siparisMSISk1YuzdeSor && index == 0
                                              ...
                                              : null,
                                          onChanged: (String p0) => setIskonto(index + 1, p0))),
                                  Expanded(
                                      child: CustomTextField(
                      ...
                      Text("Ek Açıklamalar", style: TextStyle(fontSize: UIHelper.highSize))
                          ...
                          .yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(null)),
                      CustomTextField(labelText: getAciklamaLabel(1), onChanged: (String value) => viewModel.kalemModel.aciklama1).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(1)),
                      CustomTextField(labelText: getAciklamaLabel(2), onChanged: (String value) => viewModel.kalemModel.aciklama2).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(2)),
                      CustomTextField(labelText: getAciklamaLabel(3), onChanged: (String value) => viewModel.kalemModel.aciklama3).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(3)),
                      CustomTextField(labelText: getAciklamaLabel(4), onChanged: (String value) => viewModel.kalemModel.aciklama4).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(4)),
                      CustomTextField(labelText: getAciklamaLabel(5), onChanged: (String value) => viewModel.kalemModel.aciklama5).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(5)),
                      CustomTextField(labelText: getAciklamaLabel(6), onChanged: (String value) => viewModel.kalemModel.aciklama6).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(6)),
                      CustomTextField(labelText: getAciklamaLabel(7), onChanged: (String value) => viewModel.kalemModel.aciklama7).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(7)),
                      CustomTextField(labelText: getAciklamaLabel(8), onChanged: (String value) => viewModel.kalemModel.aciklama8).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(8)),
                      CustomTextField(labelText: getAciklamaLabel(9), onChanged: (String value) => viewModel.kalemModel.aciklama9).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(9)),
                      CustomTextField(labelText: getAciklamaLabel(10), onChanged: (String value) => viewModel.kalemModel.aciklama10).yetkiVarMi(yetkiController.siparisMSSatirAciklamaAlanlari(10)),
  ...
  Future<void> getDovizData() async {
    if (viewModel.dovizliMi) {
      final GenericResponseModel<NetworkManagerMixin> dovizResult = await networkManager.dioGet(
          path: ApiUrls.getDovizKurlari,
          bodyModel: DovizKurlariModel(),
          queryParameters: <String, dynamic>{"EkranTipi": "D", "DovizTipi": viewModel.kalemModel.dovizKodu, "Tarih": DateTime.now().toDateString});
      if (dovizResult.data != null && viewModel.kalemModel.dovizTipi != null) {
        ...
        final DovizKurlariModel? result = list.firstWhereOrNull((DovizKurlariModel element) => element.dovizTipi == viewModel.kalemModel.dovizTipi);
        if (result != null) {
  ...
  Future<void> controllerFiller() async {
    viewModel.kalemModel.kalemList ??= widget.stokListesiModel?.stokList?.map(KalemModel.fromStokList).toList();
    ...
    viewModel.kalemModel.depoTanimi = parametreModel.depoList?.where((DepoList element) => element.depoKodu == viewModel.kalemModel.depoKodu).firstOrNull?.depoTanimi ?? "";
  ...
  String getIskTipiAciklama(num? value) => parametreModel.listIskTip?.firstWhereOrNull((ListIskTip element) => element.iskontoTipi == value)?.aciklama ?? "";
