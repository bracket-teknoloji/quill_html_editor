              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ).yetkiVarMi(yetkiController.lokalDepoUygulamasiAcikMi && (editTipi?.depoTransferiMi != true)),
                    Expanded(
                      child: CustomTextField(
                        labelText: "Proje",
                    ...
                    ).yetkiVarMi(yetkiController.projeUygulamasiAcikMi && (editTipi?.depoTransferiMi != true)),
                  ],
                ),
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                ...
                Row(
                  ...
                  children: [
                    ...
                    ).yetkiVarMi(!editTipi.talepTeklifMi && (editTipi?.depoTransferiMi != true)),
                    Expanded(
                      child: CustomTextField(
  ...
  Future<void> controllerFiller() async {
    if (widget.kalemModel != null) {
      ...
      if (editTipi?.satisMi == true) {
        ...
        viewModel.kalemModel.stokAlisDovTip ??= widget.stokListesiModel?.bulunanDovizTipi ?? widget.stokListesiModel?.alisDovTip ?? viewModel.model?.alisDovTip;
      }
