...
_StokFiyatiModel _$StokFiyatiModelFromJson(Map<String, dynamic> json) => _StokFiyatiModel(
...
Map<String, dynamic> _$StokFiyatiModelToJson(_StokFiyatiModel instance) => <String, dynamic>{
