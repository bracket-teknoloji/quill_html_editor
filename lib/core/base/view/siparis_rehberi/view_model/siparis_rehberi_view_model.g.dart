...
mixin _$SiparisRehberiViewModel on _SiparisRehberiViewModelBase, Store {
  late final _$siparisListAtom = Atom(
    name: '_SiparisRehberiViewModelBase.siparisList',
    context: context,
  );
  ...
  late final _$requestModelAtom = Atom(
    name: '_SiparisRehberiViewModelBase.requestModel',
    context: context,
  );
  ...
  late final _$resetPageAsyncAction = AsyncAction(
    '_SiparisRehberiViewModelBase.resetPage',
    context: context,
  );
  ...
  late final _$getDataAsyncAction = AsyncAction(
    '_SiparisRehberiViewModelBase.getData',
    context: context,
  );
