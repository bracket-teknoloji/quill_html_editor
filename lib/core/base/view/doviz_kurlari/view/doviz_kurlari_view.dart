...
class _DovizKurlariViewState extends BaseState<DovizKurlariView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: appBar(), floatingActionButton: fab(context), body: body());
  }
          ...
          BottomSheetModel(
              ...
              onTap: () async {
                if (setDovizBottomSheetList.ext.isNotNullOrEmpty) {
                  ...
                  Get.back();
                  dialogManager.showAlertDialog("Döviz kuru girişi için en fazla 2 kayıt olabilir");
                }
              }),
          BottomSheetModel(
            ...
            return viewModel.dovizKurlariList.ext.isNullOrEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      DovizKurlariModel model = viewModel.dovizKurlariList?[index] ?? DovizKurlariModel();
                      return Card(
                          child: ListTile(
                        title: Row(
        ...
        children: [
          ...
          Observer(builder: (_) {
            return CheckboxListTile.adaptive(
                title: const Text("Mevcut kurları sil ve tekrar güncelle"), value: viewModel.kurlariSilTekrarGuncelle, onChanged: (value) => viewModel.changeKurlariSilTekrarGuncelle());
