...
part of 'servis_islemleri_view_model.dart';
...
mixin _$ServisIslemleriViewModel on _ServisIslemleriViewModelBase, Store {
  ...
  Future<void> webServisleriCalistir() {
    return _$webServisleriCalistirAsyncAction.run(
      () => super.webServisleriCalistir(),
    );
  }

  late final _$dbUpdateAsyncAction = AsyncAction(
    '_ServisIslemleriViewModelBase.dbUpdate',
    context: context,
  );
  ...
  Future<void> netOpenXCreateKernel() {
    return _$netOpenXCreateKernelAsyncAction.run(
      () => super.netOpenXCreateKernel(),
    );
  }
  ...
  Future<void> netFectWinServiceRestart() {
    return _$netFectWinServiceRestartAsyncAction.run(
      () => super.netFectWinServiceRestart(),
    );
  }
