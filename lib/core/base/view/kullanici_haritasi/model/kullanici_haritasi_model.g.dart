...
_$KullaniciHaritasiModelImpl _$$KullaniciHaritasiModelImplFromJson(
...
Map<String, dynamic> _$$KullaniciHaritasiModelImplToJson(
        _$KullaniciHaritasiModelImpl instance) =>
    <String, dynamic>{
      if (instance.kullanici case final value?) 'KULLANICI': value,
      if (instance.kullaniciAdsoyad case final value?)
        'KULLANICI_ADSOYAD': value,
