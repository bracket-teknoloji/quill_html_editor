...
mixin _$GenelPdfViewModel on _GenelPdfViewModelBase, Store {
  ...
  late final _$currentPageAtom = Atom(
    name: '_GenelPdfViewModelBase.currentPage',
    context: context,
  );
  ...
  late final _$pageCounterAtom = Atom(
    name: '_GenelPdfViewModelBase.pageCounter',
    context: context,
  );
  ...
  late final _$pdfFileAtom = Atom(
    name: '_GenelPdfViewModelBase.pdfFile',
    context: context,
  );
  ...
  late final _$futureControllerAtom = Atom(
    name: '_GenelPdfViewModelBase.futureController',
    context: context,
  );
