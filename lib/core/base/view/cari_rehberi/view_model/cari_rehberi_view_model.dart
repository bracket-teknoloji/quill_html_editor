...
class CariRehberiViewModel = _CariRehberiViewModelBase
    with _$CariRehberiViewModel;
...
abstract class _CariRehberiViewModelBase with Store, MobxNetworkMixin {
  ...
  List<BaseGrupKoduModel>? get grupKodlari1 =>
      grupKodlari?.where((element) => element.grupNo == 1).toList();

  @computed
  List<BaseGrupKoduModel>? get grupKodlari2 =>
      grupKodlari?.where((element) => element.grupNo == 2).toList();

  @computed
  List<BaseGrupKoduModel>? get grupKodlari3 =>
      grupKodlari?.where((element) => element.grupNo == 3).toList();

  @computed
  List<BaseGrupKoduModel>? get grupKodlari4 =>
      grupKodlari?.where((element) => element.grupNo == 4).toList();

  @computed
  List<BaseGrupKoduModel>? get grupKodlari5 =>
      grupKodlari?.where((element) => element.grupNo == 5).toList();
  ...
  @action
  void changeBagliCariKodu(String? value) => cariListesiRequestModel =
      cariListesiRequestModel?.copyWith(bagliCariKodu: value);

  @action
  void changeSehir(String? value) =>
      cariListesiRequestModel = cariListesiRequestModel?.copyWith(sehir: value);

  @action
  void changeIlce(String? value) =>
      cariListesiRequestModel = cariListesiRequestModel?.copyWith(ilce: value);

  @action
  void changeTipi(String? value) => cariListesiRequestModel =
      cariListesiRequestModel?.copyWith(cariTipi: value);

  @action
  void changeKod1(List<String>? value) => cariListesiRequestModel =
      cariListesiRequestModel?.copyWith(arrKod1: value);

  @action
  void changeKod2(List<String>? value) => cariListesiRequestModel =
      cariListesiRequestModel?.copyWith(arrKod2: value);

  @action
  void changeKod3(List<String>? value) => cariListesiRequestModel =
      cariListesiRequestModel?.copyWith(arrKod3: value);

  @action
  void changeKod4(List<String>? value) => cariListesiRequestModel =
      cariListesiRequestModel?.copyWith(arrKod4: value);

  @action
  void changeKod5(List<String>? value) => cariListesiRequestModel =
      cariListesiRequestModel?.copyWith(arrKod5: value);

  @action
  void changeSiralama(String? value) {
    cariListesiRequestModel =
        cariListesiRequestModel?.copyWith(siralama: value);
    resetAll();
  }
  ...
  void changeFilterText(String? value) {
    cariListesiRequestModel =
        cariListesiRequestModel?.copyWith(filterText: value);
    resetAll();
  }
