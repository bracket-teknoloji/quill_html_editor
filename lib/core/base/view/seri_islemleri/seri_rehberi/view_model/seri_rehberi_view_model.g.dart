...
mixin _$SeriRehberiViewModel on _SeriRehberiViewModelBase, Store {
  ...
  late final _$requestModelAtom = Atom(
    name: '_SeriRehberiViewModelBase.requestModel',
    context: context,
  );
  ...
  late final _$searchTextAtom = Atom(
    name: '_SeriRehberiViewModelBase.searchText',
    context: context,
  );
  ...
  late final _$isSearchBarOpenAtom = Atom(
    name: '_SeriRehberiViewModelBase.isSearchBarOpen',
    context: context,
  );
  ...
  late final _$getDataAsyncAction = AsyncAction(
    '_SeriRehberiViewModelBase.getData',
    context: context,
  );
