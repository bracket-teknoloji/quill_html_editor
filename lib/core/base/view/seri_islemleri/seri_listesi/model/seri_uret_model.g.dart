...
_SeriUretModel _$SeriUretModelFromJson(Map<String, dynamic> json) => _SeriUretModel(
  seriNo: json['SERI_NO'] as String?,
  stokKodu: json['STOK_KODU'] as String?,
  sonNo: (json['SON_NO'] as num?)?.toInt(),
);

Map<String, dynamic> _$SeriUretModelToJson(_SeriUretModel instance) => <String, dynamic>{
