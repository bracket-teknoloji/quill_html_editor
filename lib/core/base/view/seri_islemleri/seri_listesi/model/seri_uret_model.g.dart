...
_$SeriUretModelImpl _$$SeriUretModelImplFromJson(Map<String, dynamic> json) => _$SeriUretModelImpl(
  seriNo: json['SERI_NO'] as String?,
  stokKodu: json['STOK_KODU'] as String?,
  sonNo: (json['SON_NO'] as num?)?.toInt(),
);

Map<String, dynamic> _$$SeriUretModelImplToJson(_$SeriUretModelImpl instance) => <String, dynamic>{
