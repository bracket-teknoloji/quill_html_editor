...
_DizaynRequestModel _$DizaynRequestModelFromJson(Map<String, dynamic> json) => _DizaynRequestModel(
  modulId: (json['ModulID'] as num?)?.toInt(),
  erpDizaynlari: json['ERPDizaynlari'] as bool?,
);

Map<String, dynamic> _$DizaynRequestModelToJson(_DizaynRequestModel instance) => <String, dynamic>{
