...
mixin _$KalemRehberiViewModel on _KalemRehberiViewModelBase, Store {
  late final _$modelAtom = Atom(name: '_KalemRehberiViewModelBase.model', context: context);
  ...
  late final _$kalemListAtom = Atom(name: '_KalemRehberiViewModelBase.kalemList', context: context);
  ...
  late final _$selectedKalemListAtom = Atom(name: '_KalemRehberiViewModelBase.selectedKalemList', context: context);
  ...
  late final _$resetPageAsyncAction = AsyncAction('_KalemRehberiViewModelBase.resetPage', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_KalemRehberiViewModelBase.getData', context: context);
