...
mixin _$PdfViewerViewModel on _PdfViewerViewModelBase, Store {
  ...
  late final _$currentPageAtom = Atom(
    name: '_PdfViewerViewModelBase.currentPage',
    context: context,
  );
  ...
  late final _$pageCounterAtom = Atom(
    name: '_PdfViewerViewModelBase.pageCounter',
    context: context,
  );
  ...
  late final _$pdfFileAtom = Atom(
    name: '_PdfViewerViewModelBase.pdfFile',
    context: context,
  );
  ...
  late final _$pdfModelAtom = Atom(
    name: '_PdfViewerViewModelBase.pdfModel',
    context: context,
  );
  ...
  late final _$futureControllerAtom = Atom(
    name: '_PdfViewerViewModelBase.futureController',
    context: context,
  );
