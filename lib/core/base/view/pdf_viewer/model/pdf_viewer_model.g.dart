...
Map<String, dynamic> _$$PdfModelImplToJson(_$PdfModelImpl instance) => <String, dynamic>{
...
Map<String, dynamic> _$$DicParamsImplToJson(_$DicParamsImpl instance) => <String, dynamic>{
