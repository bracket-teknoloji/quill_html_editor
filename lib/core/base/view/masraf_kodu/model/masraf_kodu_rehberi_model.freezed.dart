...
mixin _$MasrafKoduRehberiModel {
  String? get masrafKodu => throw _privateConstructorUsedError;
  set masrafKodu(String? value) => throw _privateConstructorUsedError;
...
/// @nodoc
@JsonSerializable()
class _$MasrafKoduRehberiModelImpl extends _MasrafKoduRehberiModel {
  _$MasrafKoduRehberiModelImpl({this.masrafKodu, this.masrafAdi}) : super._();

  factory _$MasrafKoduRehberiModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$MasrafKoduRehberiModelImplFromJson(json);
