...
mixin _$OturumlarViewModel on _OturumlarViewModelBase, Store {
  ...
  late final _$observableListAtom = Atom(name: '_OturumlarViewModelBase.observableList', context: context);
  ...
  late final _$searchTextAtom = Atom(name: '_OturumlarViewModelBase.searchText', context: context);
  ...
  late final _$isSearchBarOpenAtom = Atom(name: '_OturumlarViewModelBase.isSearchBarOpen', context: context);
  ...
  late final _$getDataAsyncAction = AsyncAction('_OturumlarViewModelBase.getData', context: context);
  ...
  late final _$logoutAsyncAction = AsyncAction('_OturumlarViewModelBase.logout', context: context);
