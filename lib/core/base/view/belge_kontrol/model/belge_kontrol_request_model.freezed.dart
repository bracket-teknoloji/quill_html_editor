...
/// Adds pattern-matching-related methods to [BelgeKontrolRequestModel].
extension BelgeKontrolRequestModelPatterns on BelgeKontrolRequestModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BelgeKontrolRequestModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _BelgeKontrolRequestModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BelgeKontrolRequestModel value)  $default,){
final _that = this;
switch (_that) {
case _BelgeKontrolRequestModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BelgeKontrolRequestModel value)?  $default,){
final _that = this;
switch (_that) {
case _BelgeKontrolRequestModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: "BaslamaTarihi")  String? baslamaTarihi, @JsonKey(name: "BitisTarihi")  String? bitisTarihi, @JsonKey(name: "Durum")  String? durum)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BelgeKontrolRequestModel() when $default != null:
return $default(_that.baslamaTarihi,_that.bitisTarihi,_that.durum);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: "BaslamaTarihi")  String? baslamaTarihi, @JsonKey(name: "BitisTarihi")  String? bitisTarihi, @JsonKey(name: "Durum")  String? durum)  $default,) {final _that = this;
switch (_that) {
case _BelgeKontrolRequestModel():
return $default(_that.baslamaTarihi,_that.bitisTarihi,_that.durum);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: "BaslamaTarihi")  String? baslamaTarihi, @JsonKey(name: "BitisTarihi")  String? bitisTarihi, @JsonKey(name: "Durum")  String? durum)?  $default,) {final _that = this;
switch (_that) {
case _BelgeKontrolRequestModel() when $default != null:
return $default(_that.baslamaTarihi,_that.bitisTarihi,_that.durum);case _:
  return null;
