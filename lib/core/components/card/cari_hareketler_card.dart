                      ...
                      children: <Widget>[
                        ListTile(
                          ...
                          title: Row(
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                      "${widget.cariHareketleriModel.alacak.commaSeparatedWithDecimalDigits(OndalikEnum.tutar)} $mainCurrency",
                          ...
                          subtitle: Wrap(
                            ...
                            ].map((CustomWidgetWithLabel e) => SizedBox(width: width * 0.33, child: e).paddingOnly(bottom: UIHelper.lowSize)).toList(),
                          ),
                        ),
                        const Divider(),
                        Row(
                          ...
                          ].map((Widget e) => e.paddingSymmetric(vertical: UIHelper.midSize, horizontal: UIHelper.highSize)).toList(),
                        )
                      ],
