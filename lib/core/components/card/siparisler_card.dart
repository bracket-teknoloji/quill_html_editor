                      ...
                      BottomSheetModel(
                          ...
                          onTap: () {
                            ...
                            return dialogManager.showAreYouSureDialog(() async {
                              if (widget.model.isNew == true) {
                                try {
                                  await CacheManager.removeSiparisEditList(widget.index!);
                              ...
                              final GenericResponseModel<NetworkManagerMixin> result = await networkManager.deleteFatura(const EditFaturaModel().fromJson(widget.model.toJson()));
          ...
          children: <Widget>[
            ...
            LayoutBuilder(
                builder: (BuildContext context, BoxConstraints constrains) => Wrap(
                      ...
                      ].whereType<Widget>().map((Widget e) => e is SizedBox ? null : SizedBox(width: constrains.maxWidth / 2, child: e)).whereType<Widget>().toList(),
                    )),
            // Row(
            //   crossAxisAlignment: CrossAxisAlignment.start,
            //   children: [
            ...
            Row(
              ...
              ].map((Widget e) => e is SizedBox ? null : e).whereType<Widget>().toList(),
