...
class CustomAnimatedGridViewModel = _CustomAnimatedGridViewModelBase
    with _$CustomAnimatedGridViewModel;
...
abstract class _CustomAnimatedGridViewModelBase with Store {
  ...
  @observable
  ObservableList<ObservableList<GridItemModel>> returnGridItemModel =
      <ObservableList<GridItemModel>>[].asObservable();

  @action
  void setGridItemModel(List<GridItemModel>? value) =>
      gridItemModelList = value?.asObservable();
