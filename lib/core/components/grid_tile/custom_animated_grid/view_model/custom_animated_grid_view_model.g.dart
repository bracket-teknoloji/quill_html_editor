...
mixin _$CustomAnimatedGridViewModel on _CustomAnimatedGridViewModelBase, Store {
  late final _$gridItemModelListAtom = Atom(name: '_CustomAnimatedGridViewModelBase.gridItemModelList', context: context);
  ...
  late final _$returnGridItemModelAtom = Atom(name: '_CustomAnimatedGridViewModelBase.returnGridItemModel', context: context);
  ...
  late final _$_CustomAnimatedGridViewModelBaseActionController = ActionController(name: '_CustomAnimatedGridViewModelBase', context: context);

  @override
  void setGridItemModel(List<GridItemModel>? value) {
    final _$actionInfo = _$_CustomAnimatedGridViewModelBaseActionController.startAction(name: '_CustomAnimatedGridViewModelBase.setGridItemModel');
    try {
      return super.setGridItemModel(value);
    } finally {
      _$_CustomAnimatedGridViewModelBaseActionController.endAction(_$actionInfo);
    }
  }

  @override
  void addReturnGridItemModel(List<GridItemModel>? value) {
    final _$actionInfo = _$_CustomAnimatedGridViewModelBaseActionController.startAction(name: '_CustomAnimatedGridViewModelBase.addReturnGridItemModel');
    try {
  ...
  void deleteLastReturnGridItemModel() {
    final _$actionInfo = _$_CustomAnimatedGridViewModelBaseActionController.startAction(name: '_CustomAnimatedGridViewModelBase.deleteLastReturnGridItemModel');
    try {
