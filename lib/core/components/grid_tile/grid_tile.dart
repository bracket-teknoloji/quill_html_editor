...
final class CustomGridTileState extends BaseState<CustomGridTile> {
                ...
                : Column(
                  ...
                  children: [
                    AnimatedContainer(
                      ...
                      child:
                          widget.model?.iconData == null
                              ? IconHelper.bigMenuIcon(widget.model?.icon ?? "")
                              : IconTheme(
                                data: const IconThemeData(weight: 0.1, size: 30, color: Colors.white),
                                child: Icon(widget.model?.iconData, size: UIHelper.midSize * 3, grade: 0.1),
                              ),
  ...
  Widget? header() =>
      (widget.model?.menuTipi == "I" || widget.model?.menuTipi == "SR")
          ? Align(
  ...
  Widget footer() =>
      (widget.model?.menuTipi == "S" && (widget.model?.altMenuler.ext.isNotNullOrEmpty ?? false))
