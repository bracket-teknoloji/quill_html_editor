...
class DialogManager {
  ...
  Future showAreYouSureDialog(void Function() onYes, {String? title}) async =>
      await _areYouSureDialog(onYes, title).show();
  ...
  Future<void> showDialog(
          {required Widget body, void Function()? onYes}) async =>
      await _baseDialog(
              body: body,
              onOk: onYes,
              onCancel: () {},
  ...
  void showGridViewDialog(Widget body) => _baseDialog(
          body: body,
          onOk: () {},
          btnOkText: "İptal",
  ...
  void showCariGridViewDialog(CariListesiModel? model, [IslemTipiEnum? tip]) =>
      _baseDialog(
              body: CustomAnimatedGridView<CariListesiModel>(
                  cariListesiModel: model,
                  model: model,
                  islemTipi: tip ?? IslemTipiEnum.cari),
              onOk: () {},
              btnOkText: "İptal",
              dialogType: DialogType.noHeader)
          .show();

  Future<dynamic> showKasaGridViewDialog(KasaListesiModel? model,
          {IslemTipiEnum? tip, Function(bool)? onSelected}) async =>
      await _baseDialog(
  ...
  void showCariRaporlarGridViewDialog() => _baseDialog(
          body: const CustomAnimatedGridView(
              title: "Raporlar", islemTipi: IslemTipiEnum.cariRapor),
          onOk: () {},
          btnOkText: "İptal",
          dialogType: DialogType.noHeader)
      .show();
  ...
  void showStokGridViewDialog(StokListesiModel? model, [IslemTipiEnum? tip]) =>
      _baseDialog(
              body: CustomAnimatedGridView<StokListesiModel>(
                  model: model, islemTipi: tip ?? IslemTipiEnum.stok),
              onOk: () {},
              btnOkText: "İptal",
              dialogType: DialogType.noHeader)
          .show();
  ...
  Future<dynamic> showSiparisGridViewDialog(
          ...
          Function(bool)? onSelected}) async =>
      await _baseDialog(
  ...
  SnackBar _snackBarInfo(String message) => SnackBar(
      content: Text(message),
      behavior: SnackBarBehavior.floating,
    ...
    return _baseDialog(
        ...
        body: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          ...List.generate(
            ...
            (index) {
              var title = (CacheManager.accountsBox.getAt(index)?.firma ?? "")
                  .toString();
  ...
  AwesomeDialog _baseDialog(
    ...
    return AwesomeDialog(
        ...
        bodyHeaderDistance:
            dialogType != DialogType.noHeader ? 15 : UIHelper.lowSize,
        enableEnterKey: true,
        context: context,
        isDense: true,
        width: kIsWeb
