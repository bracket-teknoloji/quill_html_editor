...
abstract class _RaporFiltreDateTimeBottomSheetViewModelBase with Store {
  ...
  @observable
  ObservableList<bool> selectedValueList = ObservableList.of(<bool>[true, false, false, false, false, false, false, false, false, false]);

  @action
  void changeSelectedValue(int index) {
    selectedValueList = ObservableList.of(<bool>[false, false, false, false, false, false, false, false, false, false]);
  ...
  final List<String> childrenTitleList = <String>["Tümü", "Bugün", "Dün", "Bu Hafta", "Bu Ay", "Geçen Ay", "Son 3 Ay", "Bu Yıl", "Geçen Yıl"];

  final Map<String, DateTime?> startDateMap = <String, DateTime?>{
    "Tümü": null,
    "Bugün": DateTime.now(),
  ...
  final Map<String, DateTime?> finishDateMap = <String, DateTime?>{
    "Tümü": null,
    "Bugün": DateTime.now(),
    "Dün": DateTime.now().subtract(const Duration(days: 1)),
