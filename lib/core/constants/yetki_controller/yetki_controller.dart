...
class YetkiController {
  ...
  bool get ebelgeEFaturaGidenKutusu => isTrue(yetkiModel?.ebelgeEFaturaGidenKutusu);
  ...
  bool get ebelgeEArsivGidenKutusu => isTrue(yetkiModel?.ebelgeEArsivGidenKutusu);
