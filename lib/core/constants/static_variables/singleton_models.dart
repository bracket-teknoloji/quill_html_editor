...
final class SingletonModels {
  ...
  static PrintModel get sayimPrintModel => _sayimPrintModel ?? PrintModel(raporOzelKod: DizaynOzelKodEnum.sayim.ozelKodAdi, dicParams: DicParams(belgeTipi: "SAYI", belgeNo: ""));
