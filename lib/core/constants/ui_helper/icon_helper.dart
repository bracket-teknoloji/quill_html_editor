...
final class IconHelper {
  ...
  static SvgPicture mediumIcon(String path, {Color? color}) => SvgPicture.asset(
        _getIconPath(path),
        height: 24,
        colorFilter: ColorFilter.mode(color ?? UIHelper.primaryColor, BlendMode.srcIn),
      );
  static SvgPicture mediumIconWhite(String path, {Color? color}) => SvgPicture.asset(
        _getIconPath(path),
        height: 24,
        colorFilter: ColorFilter.mode(color ?? Colors.white, BlendMode.srcIn),
      );
  static SvgPicture mediumIconBlack(String path, {Color? color}) => SvgPicture.asset(
        _getIconPath(path),
        height: 24,
  ...
  //* Small Icon
  //*
  static SvgPicture smallIcon(String path, {Color? color, double? size}) => SvgPicture.asset(
        _getIconPath(path),
        height: size ?? 20,
        colorFilter: ColorFilter.mode(
          color ?? UIHelper.primaryColor,
  ...
  static SvgPicture smallIconWhite(String path, {Color? color}) => SvgPicture.asset(
        _getIconPath(path),
        height: 20,
        colorFilter: ColorFilter.mode(color ?? Colors.white, BlendMode.srcIn),
      );
  static SvgPicture smallIconBlack(String path, {Color? color}) => SvgPicture.asset(
        _getIconPath(path),
        height: 20,
        colorFilter: ColorFilter.mode(color ?? Colors.black, BlendMode.srcIn),
      );
