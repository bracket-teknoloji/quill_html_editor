...
final class TextStyleHelper {
  ...
  //* Title
  //*
  static const TextStyle title = TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: UIHelper.primaryColor);
  ...
  //* Subtitle
  //*
  static const TextStyle subtitle = TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: UIHelper.primaryColor);
  ...
  //* Body
  //*
  static const TextStyle caption = TextStyle(fontSize: 12, fontWeight: FontWeight.normal, color: UIHelper.primaryColor);
